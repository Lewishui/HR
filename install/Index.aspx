<%@ Page Language="C#" validateRequest="false" enableEventValidation="false" viewStateEncryptionMode ="Never" AutoEventWireup="true" Inherits="Kesion.ICMS.InstallIndex" CodeFile="Index.aspx.cs" %>
...
<body>
	...
	<div class="guide">
		...
		<div class="datiao">
			<ul>
				<li class="curr">阅读许可协议<i class="after"></i></li>
				<li><i class="before"></i>检查安装环境<i class="after"></i></li>
				<li><i class="before"></i>创建数据库<i class="after"></i></li>
				<li><i class="before"></i>网站参数配置<i class="after"></i></li>
				<li><i class="before"></i>完成安装<i class="after"></i></li>
			</ul>
		</div>
		<div class="clear"></div>
		<div class="guideboxbig  clearfix">
			<div class="guidebox">
		...
		<div class="datiao">
			<ul>
				<li>阅读许可协议<i class="after"></i></li>
				<li class="curr"><i class="before"></i>检查安装环境<i class="after"></i></li>
				<li><i class="before"></i>创建数据库<i class="after"></i></li>
				<li><i class="before"></i>网站参数配置<i class="after"></i></li>
				<li><i class="before"></i>完成安装<i class="after"></i></li>
			</ul>
		...
		<asp:Panel ID="Step3" runat="server" Visible="false">
		 <div class="datiao">
			<ul>
				<li>阅读许可协议<i class="after"></i></li>
				<li><i class="before"></i>检查安装环境<i class="after"></i></li>
				<li class="curr"><i class="before"></i>创建数据库<i class="after"></i></li>
				<li><i class="before"></i>网站参数配置<i class="after"></i></li>
				<li><i class="before"></i>完成安装<i class="after"></i></li>
			</ul>
		 </div>
		...
		<div class="sjlist">
			...
			<ul>
				...
				<li><span style="display:none">初始数据：&nbsp;<strong> <asp:CheckBox ID="CkbData" runat="server" Text="安装体验数据包(推荐)" Checked="true" /></span>
			    ...
			    function doAjax() {
			     ...
			     function doBegin() {
			         ...
			         $.ajax({
			             ...
			             success: function(d) {
			                 if (d == 'success') {
			                     KesionJS.Alert("恭喜，KesionI<%=Utils.GetSysInfo("//sysinfo/showver") %>产品数据库安装成功，点击确定进入网站基本参数配置！", "location.href = 'index.aspx?action=finish';");
			                 } else {
			                 KesionJS.Alert(d);
		...
		<asp:Panel ID="Step4" runat="server" Visible="false">
		 ...
		 <div class="datiao">
			<ul>
				<li>阅读许可协<i class="after"></i>议</li>
				<li><i class="before"></i>检查安装环境<i class="after"></i></li>
				<li><i class="before"></i>创建数据<i class="after"></i>库</li>
				<li class="curr"><i class="before"></i>网站参数配置<i class="after"></i></li>
				<li><i class="before"></i>完成安装<i class="after"></i></li>
			</ul>
		 </div>
		 <div class="clear"></div>
		...
		<div class="datiao">
			<ul>
				...
				<li><i class="before"></i>创建数据库<i class="after"></i></li>
				<li><i class="before"></i>网站参数配置<i class="after"></i></li>
				<li class="curr"><i class="before"></i>完成安装<i class="after"></i></li>
			</ul>
		 </div>
		<div class="clear"></div>
		
		<div class="hjlist" style="padding:20px"><br /><br />
		  <h4 style="color:Green;line-height:35px;"><img src="../sysimg/default/ok.png" align="absmiddle" />恭喜，KesionI<%=Utils.GetSysInfo("//sysinfo/showver") %>产品安装成功！
	...
	<div class="foot">
		<font disabled>Powered By KesionI<%=Utils.GetSysInfo("//sysinfo/showver") %> <a href="http://www.kesion.com/" target="_blank">www.kesion.com</a> inc.<br />福建·厦门科汛软件有限公司版权所有 © 2006-<%=DateTime.Now.Year.ToString() %> </font>
	</div>
