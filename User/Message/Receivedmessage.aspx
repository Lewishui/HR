...
<div class="r_padbox">
    ...
    <ItemTemplate>
      <tr class="tdbg">
          ...
          <td class="splittd"><a href="?Action=Show&ID=<%# Eval("ID") %>"><img src="../images/msg<%#Eval("ReadTF") %>.gif" align="absbottom" /><%#Eval("MsgTitle") %></a>
    ...
    <div class="cz_btn">
        ...
        <span>将选中的留言  <asp:Button ID="ButtonDel" class="button" runat="server" Text="永久删除" OnClick="ButtonDel_Click"/></span>
        <span><asp:Button ID="ButtonDelTF" CssClass="button" runat="server" Text="转为垃圾消息" OnClick="ButtonDelTF_Click" /></span>
    </div>
...
<table width="98%" align="center" border="0" cellspacing="0" cellpadding="5" class="border">
  <tr class="tdbg">
    <td class="splittd" style="word-break:break-all;text-align:left">
 ...
 <div style="text-align:center">
 	<div class="cz_btn">
    	<span><asp:Button ID="Button1" CssClass="button" runat="server" Text="删除留言" OnClick="Button1_Click"/></span>
    </div>         
 </div>
