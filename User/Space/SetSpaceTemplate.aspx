...
<html>
	   ...
	   <style type="text/css">
		...
		.diytitle{height:30px;background:#f1f1f1;font-size:14px;padding-left:30px;font-weight:bold;padding-top:4px;cursor: move;}
				...
				<div class="tplist" id="c0">
				  <ul id="tplist" >
                      <asp:Repeater ID="Rept" runat="server" >
                          <ItemTemplate>
                              <a href="javascript:" class="tplink" >
                                  <img onerror="this.src='/sysimg/nopic.gif'" src='<%#Eval("DefaultPic") %>' tplt='<%#Eval("TemplateEname") %>' tpltID='<%#Eval("TemplateID") %>' alt='<%#Eval("Templatename") %>' title='<%#Eval("Templatename") %>' runat="server" width="120" height="120" /></a>
                          </ItemTemplate>
                      </asp:Repeater>
                  </ul>
