        ...
        if (isNaN($("#<%=this.tboxListReplayNum.ClientID %>").val())) {
            ...
            <tr class="tdbg">
              ...
              <td style="text-align:left">
              		<asp:TextBox ID="TxtBlogName" CssClass="textbox"  Enabled="true" runat="server" value=""></asp:TextBox>
               		<span class="tips">空间站点的名称。如我的家园，我的博客等</span>
               </td>
            </tr>
            ...
            <tr class="tdbg">
              ...
              <span style="display:none"><asp:TextBox ID="txtLogo" CssClass="textbox" runat="server"></asp:TextBox></span>
            ...
            <tr class="tdbg">
              ...
              <td style="text-align:left">
               ...
               <span class="tips">空间站点分类，以便游客查找</span>
            ...
            <tr class="tdbg">
              ...
              <td style="text-align:left"><textarea class="textbox" runat="server" name="txtDescript" id="txtDescript" style="width:80%;height:60px; padding:10px" cols=50 rows=6>本空间欢迎大家一块交流讨论KesionICMS,包括她的使用心得,使用方法和新版开发建议..</textarea>
              
              
              
              <br/><span class="tips" style="padding-left:0px">关于您的空间站点介绍</span> </td>
            </tr>
            <tr class="tdbg">
              <td class="clefttitle">空间公告：</td>
              <td style="text-align:left"><textarea class="textbox" runat="server" name="txtAnnounce" id="txtAnnounce" style="width:80%;height:60px; padding:10px" cols=50 rows=6>KesionICMS 测试版本发布！！！</textarea><br/><span class="tips" style="padding-left:0px">发布您的最新活动公告，让更多用户了解您。</span></td>
            </tr>
            <tr class="tdbg" style="display:none;">
              <td class="clefttitle">新 鲜 事：</td>
              <td>列表页每页显示<asp:TextBox ID="tboxContentLen" CssClass="textbox"  Enabled="true" runat="server" style="width:50px; border-top:none; border-left:none; border-right:none;"></asp:TextBox> 条  <span class="tips">指空间新鲜事列表页里，每页显示新鲜事条数。</span>    </td>
            </tr>
            <tr class="tdbg" style="display:none;">
              <td class="clefttitle">显示博文：</td>
              <td>首页显示博文<asp:TextBox ID="tboxListBlogNum" CssClass="textbox"  Enabled="true" runat="server" style="width:50px; border-top:none; border-left:none; border-right:none;"></asp:TextBox>篇 <span class="tips">空间首页显示博文条数。</span>             </td>
            </tr>
            <tr class="tdbg" style="display:none;">
              <td class="clefttitle">显示回复：</td>
              <td>首页显示回复<asp:TextBox ID="tboxListReplayNum" CssClass="textbox"  Enabled="true" runat="server" style="width:50px; border-top:none; border-left:none; border-right:none;"></asp:TextBox>条  <span class="tips">空间首页显示最新回复条数。</span>              </td>
            </tr>
            <tr class="tdbg" style="display:none;">
              <td class="clefttitle">博文列表：</td>
              <td>列表页显示博文<asp:TextBox ID="tboxListLogNum" CssClass="textbox"  Enabled="true" runat="server" style="width:50px; border-top:none; border-left:none; border-right:none;"></asp:TextBox>篇  <span class="tips">空间首页显示最新博文篇数。 </span>             </td>
            </tr>
            <tr class="tdbg" style="display:none;">
              <td  class="clefttitle">显示留言：</td>
              <td  valign=top>首页显示留言<asp:TextBox ID="tboxListGuestNum" CssClass="textbox"  Enabled="true" runat="server" style="width:50px; border-top:none; border-left:none; border-right:none;"></asp:TextBox>条    <span class="tips">空间首页显示最新留言条数。</span>        </td>
            </tr>

            <tr class="tdbg">
			  <td style="border-bottom:0px;">&nbsp;</td>
              <td height="30" style="border-bottom:0px; text-align:left">
			    	<div class="cz_btn"><asp:Button ID="Button1"  CssClass="button" OnClientClick="return(checkform())" runat="server" Text="OK,提交修改" onclick="Button1_Click" /></div>
               </td>
            </tr>
