	...
	<div class="r_tybox nomar">
        ...
        <div class="tabs">
            <ul>
                ...
                <li class="puton"><a href="UserAlbumComment.aspx">相册评论管理</a></li>
            </ul>
    ...
    <KS:ksgv id="List" runat="server" CssClass="border" AutoGenerateColumns="False" EmptyDataText="无记录" PagerType="CustomNumeric" Width="99%" HorizontalAlign="center" GridLines="None" OnRowDataBound="List_RowDataBound" OnRowCommand="List_RowCommand" OnRowCreated="List_RowCreated" >
            <Columns>
                ...
                <asp:TemplateField HeaderText="标题" ItemStyle-CssClass="splittd" ItemStyle-Width="400" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" >
                    <ItemTemplate>
                        <%# (bool)string.IsNullOrEmpty(Eval("Title").ToString())? "(无)": "<a href='"+Kesion.HtmlTags.BasicField.GetBlogAlbumUrl(Utils.StrToInt(Eval("logID").ToString()),Eval("userid").ToString()) +"' target='_blank'>"+Eval("Title")+"</a>"%>
                    </ItemTemplate>
                </asp:TemplateField>
         ...
         <table cellspacing="1" cellpadding="3" class="border" width="100%" align="center" border="0">
          <tr class="tdbg">
           ...
           <tr class="tdbg">
            ...
            <asp:Button ID="Button1" runat="server" OnClientClick="return CheckForm()" class="button" text=" 回 复 " OnClick="Unnamed1_Click" />　　 <asp:Button runat="server" class="button" text=" 返 回 " OnClick="Unnamed1_Click2" />
