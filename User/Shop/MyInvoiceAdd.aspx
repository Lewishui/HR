			 ...
			 <td>
				  <table class="cctable">
					<tr>
					 ...
					 <td><input type="text" class="textbox" size="30" name="i_ComapanyName" id="i_ComapanyName" maxlength="100"/></td>
					</tr>
					<tr>
					 <td class="ccleft"><font color=red>*</font>纳税人识别号：</td>
					 <td> <input type="text" class="textbox" size="30"  name="i_NSRSBH" id="i_NSRSBH"  maxlength="100"/></td>
					</tr>
					<tr>
					 <td class="ccleft"><font color=red>*</font>注册地址：</td>
					 <td> <input type="text" class="textbox" size="30"  name="i_Address" id="i_Address"  maxlength="100"/></td>
					</tr>
					<tr>
					 <td class="ccleft"><font color=red>*</font>注册电话：</td>
					 <td> <input type="text" class="textbox" size="30" name="i_Tel" id="i_Tel"  maxlength="100"/></td>
					</tr>
					<tr>
					 <td class="ccleft"><font color=red>*</font>开户银行：</td>
					 <td> <input type="text" class="textbox" size="30" name="i_Bank" id="i_Bank"  maxlength="100"/></td>
					</tr>
					<tr>
					 <td class="ccleft"><font color=red>*</font>银行帐户：</td>
					 <td> <input type="text" class="textbox" size="30"  name="i_BankNum" id="i_BankNum"  maxlength="100"/></td>
					</tr>
				  </table>
			 </td>
			</tr>
