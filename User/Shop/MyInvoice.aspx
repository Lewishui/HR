...
<div class="r_tybox nomar">
    ...
    <HeaderTemplate>
<div class="r_padbox">
	<div class="padnav"><span><input type="button" class="button" onclick="addInvoice();" value="新增发票信息" /></span>
    <span class="tips">
    您已创建<span class="red"><%=num %></span> 个发票信息，最多可创建<span class="red">20</span>个。</span></div>
    ...
    <ItemTemplate>
       <tr class="tdbg">
          ...
          <td class="splittd">
           ...
           <input type="button" class="button" value="删除" onclick="$.dialog.confirm('确定删除该发票信息吗？',function(){ location.href='shop/myinvoice.aspx?action=del&id=<%# Eval("invoiceid") %>';},function(){});"/>
