...
MoodPosition=function(itemid){
 	  ...
 	  jQuery.ajax({url:'<%=MyCache.GetCacheConfig(5)+MyCache.GetCacheConfig(0)%>plus/Mood.aspx',cache:false,data:'action=hits&itemid='+itemid+'&id=<%=moodid%>&m_ID=<%=channelid%>&c_id=<%=infoid%>',success:function(obj){
