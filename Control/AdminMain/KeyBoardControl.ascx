...
<div id="keycontainer">
   <div id="keytitle"><span style="float:right;padding-right:10px;cursor:pointer" onclick="$('#keycontainer').hide();">[close]</span>===KESION »Ìº¸≈Ã===</div>
	<ul id="keyboard">
    </ul>
