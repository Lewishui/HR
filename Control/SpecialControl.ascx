<%@ Control Language="C#" AutoEventWireup="true" Inherits="Kesion.NET.WebSite.Control_SpecialControl" Codebehind="SpecialControl.ascx.cs" %>
 ...
 <tr>
	<td style="width:200px" id='SpecialList'>
          <select name='SpecialID' id="SpecialID" multiple="multiple" style="height:100px;width:420px;"><%=OptionStr%></select>
          <div style='text-align:left'><span style="color:Red">X</span> <a href='javascript:UnSelectAll()'><font color='#999999'>取消选定的专题</font></a></div></td>
