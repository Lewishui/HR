<%@ Control Language="C#" AutoEventWireup="true" Inherits="Kesion.NET.WebSite.Shop.CountOrderWMYControl" Codebehind="CountOrderWMYControl.ascx.cs" %>
...
<div class="tabs_header">
    <ul class="tabs">
    <li<%=KSCMS.S("showType")==""?" class='active'":string.Empty %>><a href="?<%=UtilsQueryParam.Get("showtype") %>"><span>总订单数</span></a></li>
    ...
    <li><a href="KS.ShopStats.aspx?action=CountOrder"><span>时间段</span></a></li>
    </ul>
</div>
