<%@ Control Language="C#" AutoEventWireup="true" Inherits="Kesion.NET.WebSite.Shop.UserBillShowCommentControl" CodeBehind="UserBillShowCommentControl.ascx.cs" %>
...
<asp:Repeater ID="Repeater1" runat="server" onitemdatabound="Repeater1_ItemDataBound" >
   <HeaderTemplate>
        ...
        <div class="comment_con">
        	<div class="left">
            	<div class="img">
                    <img height="110" src="<%# Kesion.NET.WebSite.User_MyComment.GetDefaultPic(3,Convert.ToInt32(Eval("infoid")))%>" width="110" />
                </div>
                <p> <%# Kesion.NET.WebSite.User_MyComment.GetTitle(3,Convert.ToInt32(Eval("infoid"))) %></p>
