...
<table width="99%" style="margin-top:10px" border="0" align="center" cellpadding="1" cellspacing="1" class="CTable">
		<tr class="tdbg">
						<td height='25' class='clefttitle' colspan='4' style="text-align:left"><strong>订单来源</strong> （了解客户的购物习惯） </td>
		  </tr>
					  <tr class="tdbg">
						<td height="30" style="text-align:center">
                           PC端</td>
						<td height="30" style="text-align:center">手机端</td>
						<td height="30" style="text-align:center">微信</td>
					  </tr>
					  <tr>
						<td height="30" style="text-align:center">
                           <%=DataFactory.GetOnlyValue("select count(1) From KS_ProOrder Where OrderDevice=0") %></td>
						<td height="30" style="text-align:center">
                           <%=DataFactory.GetOnlyValue("select count(1) From KS_ProOrder Where OrderDevice=1") %></td>
						<td height="30" style="text-align:center">
                           <%=DataFactory.GetOnlyValue("select count(1) From KS_ProOrder Where OrderDevice=2") %></td>
					  </tr>
					</table>
<table width="99%" style="margin-top:10px" border="0" align="center" cellpadding="1" cellspacing="1" class="CTable">
		<tr class="tdbg">
...
showtips('<span class="state"><strong>说明：</strong><br /></span>“有效订单”指的是订单已结清，并没有退款的订单,“有效销售购物额/销售额/金额”指的是已被结清且未申请退款的订单销售总额!');
</script>
