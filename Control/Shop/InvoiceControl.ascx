...
<table class="Border" cellSpacing=1 cellPadding=2 width="99%" align="center" border=0>
    ...
    <tr class="tdbg">
        <td align="right" width="15%">
            发票号码：</td>
        <td>
            <asp:TextBox  CssClass="textbox" ID="TxtInvoiceNum" runat="server" Width="200px" MaxLength="50"></asp:TextBox></td>
    </tr>
    <tr class="tdbg">
        <td align="right" width="15%">
            发票抬头：</td>
        <td>
            <asp:TextBox  CssClass="textbox" ID="TxtInvoiceTitle" runat="server" Width="200px" MaxLength="50"></asp:TextBox></td>
    </tr>
    <tr class="tdbg">
        <td align="right" width="15%">
            发票金额：</td>
        <td>
            <asp:TextBox  CssClass="textbox" ID="TxtMoneyTotal" runat="server" Width="60px" MaxLength="50"></asp:TextBox>
    ...
    <tr class="tdbg">
        <td align="right" width="15%">
            发票内容：</td>
        <td>
            <asp:TextBox  CssClass="textbox" ID="TxtInvoiceContent" runat="server" Width="200px"  MaxLength="50"></asp:TextBox></td>
    </tr>
    <tr class=tdbg>
