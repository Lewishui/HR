...
<table class="CTable" cellSpacing=1 cellPadding=1 width="99%" border=0>
    <tr class=tdbg>
      ...
      <td><asp:Label ID="LabClientName" runat="server" Text=""></asp:Label>
          (用户名：<asp:Label ID="LabUserName" runat="server" Text=""></asp:Label>)
      </td>
    ...
    <tr class=tdbg>
      ...
      <td>
         <asp:DropDownList CssClass="select" ID="DrpDeliveryCorpId" runat="server"></asp:DropDownList>
          快递单号： <asp:TextBox  CssClass="textbox" ID="TxtExpressOrderID" runat="server" Width="200px"></asp:TextBox>
      </td>
    </tr>
