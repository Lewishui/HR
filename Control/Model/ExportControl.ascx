...
<KS:TopNav ID="TopNav1" runat="server" />
 <div class="content-area"> 
  <div class="tabs_header">
    <ul class="tabs">
    <li class='active'><a href="#"><span>模型导出</span></a></li>
    <li><a href="KS.ModelExportOrImport.aspx?action=import"><span>模型导入</span></a></li>
    </ul>
   </div>
  
    <asp:Panel ID="Panel1" runat="server" Width="100%">
    <table  width="98%" border="0" cellpadding="1" cellspacing="1" class="CTable">
		<tr>
