<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Inherits="Kesion.NET.Mobile.Admin.Weixin.KS_ShopList" Codebehind="KS.ShopList.aspx.cs" %>
...
<script>
    ...
    function SelectShopPage(FieldID) {
        top.openWin("选择商品", "weixin/KS.GetShop.aspx?action=<%=action%>&id=<%=sendId%>&nowIndex=" + parent.nowIndex + "&fieldID=" + FieldID, false, 1000, 500); 
    }
</script>
    <script type="text/javascript">
        $(function () {
            var tempstr = $("#ShowTxtShop<%=sendId%>", parent.document).val();
            if (tempstr.length > 10) {
                $("#myshoppic").html(tempstr);
            }
        });
        //iframe 自适应高度
...
<asp:Panel ID="Panel11" runat="server">
 ...
 <div class="tab_cont_cover jsMsgSendTab" data-index="0" style="display: block;">
                       ...
                       <div style="display:none"><asp:TextBox ID="txtSite" runat="server"  CssClass="inp245" Width="50%" ></asp:TextBox></div>
			            ...
			            <span class="create_access" id="myshoppic" onclick="SelectShopPage('<%=this.txtSite.ClientID%>');">
...
<div id="msgSender_media_1_10" ><div class="appmsg " >
    <div class="appmsg_content">
		 ...
		 <div class="article_info">
            ...
            <p class="appmsg_desc">￥<%=Price_Member %></p>
            <p class="appmsg_intro"><%=Intro%></p>
		 </div>
