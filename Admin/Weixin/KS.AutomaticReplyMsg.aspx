<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Inherits="Kesion.NET.Mobile.Admin.Weixin.KS_AutomaticReplyMsg" Codebehind="KS.AutomaticReplyMsg.aspx.cs" %>
 ...
 <div class="content-area">    
   ...
   <script>
         ...
         function aa(k) {
             ...
             $(".menu1box ul li").each(function (index, domEle) {
                 if (k == index) {
                     ...
                     if (k == 0) {
                         $('#iframemain0').attr('src', 'KS.TuWenList.aspx?action=AutomaticReply&keyId=<%=keyId%>');
                         ...
                         $('#iframemain0').attr('src', 'KS.ShopList.aspx?action=AutomaticReply&keyId=<%=keyId%>');

                     }
                     else if (k == 3) {
                         $('#iframemain0').attr('src', 'KS.SuCaiList.aspx?action=AutomaticReply&keyId=<%=keyId%>');
    ...
    <div class="openKey" style="margin-right: 20px;margin-left: 10px;margin-bottom: 0;">
        <span class="txt" style="float:left;">是否要开启消息回复:</span>
          ...
          <asp:RadioButtonList ID="RdbStatus" RepeatDirection="Horizontal" runat="server" style=" margin-right:5px;" onclick="showStatus()">
           ...
           <span class="tips" style="font-weight:normal;padding-left:30px;">Tips:如果有启用多客服系统，这里设置的消息回复会失效；客服系统的优先级高于消息回复；</span>
           <div class="clear"></div>
     </div>
 ...
 <div id="detail" style="display:none">
	 ...
	 <textarea id="ShowTxtSuCai0" style="width:300px;height:200px;display:none"></textarea>
        <div class="phone_right">
                                ...
                                <div class="menu1box">
                                    <ul class="menu1">
                                       <li class="hit">
                                            ...
                                            <a href="KS.TuWenList.aspx?action=AutomaticReply&keyId=<%=keyId%>"  onclick="$('#mybox1').show();$('#mybox2').hide();" target="iframemain0" >
                                     ...
                                     <li>
                                        ...
                                        <li>
                                            ...
                                            <a href="KS.ShopList.aspx?action=AutomaticReply&keyId=<%=keyId%>" onclick="$('#mybox2').hide();$('#mybox1').show();"  target="iframemain0">
                                        ...
                                        <li >
                                            ...
                                            <a href="KS.SuCaiList.aspx?action=AutomaticReply&keyId=<%=keyId%>"  onclick="$('#mybox1').show();$('#mybox2').hide();" target="iframemain0" >
                                ...
                                <div class="main1box">
                                    <div class="main">
                                        <dt class="mbimg" style="display:block; " id="mybox1">
                                            <iframe class="editArea-ifrm" frameborder="no" border="0" src="KS.TuWenList.aspx?action=AutomaticReply&keyId=<%=keyId%>" style="width:100%;" name="iframemain0" id="iframemain0" > </iframe>
                                        </dt>
           ...
           <div class="opr1">
               <br /><Br />
                  <asp:Button ID="ButtonAdd" runat="server" Text="保存" class="btn btn_primary Js_rule_save" OnClick="ButtonAdd_Click" />
            </div>
