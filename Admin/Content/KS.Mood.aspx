...
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
    ...
    <div id="manage_top" class="menu_top_fixed">
        <ul class="titleTab"><li><strong>管理操作：</strong></li>
          <li><a href="KS.Comment.aspx">评论管理</a></li>
              <li><a href="KS.DiggList.aspx">Digg管理</a></li>
              <li class="curr"><a href="KS.Mood.aspx">表情管理</a></li>
        </ul>
        </div>  
       <div class="menu_top_fixed_height"></div> 
       <div class="content-area">
        <div class="myTitle">
        	<div class="fr"><asp:LinkButton ID="addMoodProjectBtn" CssClass="button" runat="server" OnClick="addProject_Click"><b></b>添加项目</asp:LinkButton></div>
        	表情管理
	  ...
	  <div class="listedit">
          ...
          <asp:LinkButton ID="editMoodProjectBtn" CssClass="button" runat="server" OnClick="editMoodProject_Click"><b></b>编辑项目</asp:LinkButton>
          <asp:LinkButton ID="delMoodProjectBtn" CssClass="button" runat="server" OnClick="delMoodProject_Click"><b></b>删除项目</asp:LinkButton>
      </div>
            ...
            <tr>
                ...
                <%
                    ...
                    for (int i = 1; i <=15; i++)
                    {
                        ...
                        Response.Write(string.Format(@"{1}{0}、名称<input class='textbox' type='text' name='name{0}' size='12' value='{2}' /> 图片地址<input type='text' class='textbox' name='pic{0}' size='12' value='{3}'/><br/><br/>", i.ToString(), i.ToString().Length == 1 ? "0" : "", nameValue, picValue));
                    }
                 %>    
                </td>
            </tr>
