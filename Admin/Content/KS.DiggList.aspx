...
<div id="manage_top" class="menu_top_fixed">
     ...
     <ul class="titleTab"><li><strong>管理操作：</strong></li>
             <li><a href="KS.Comment.aspx">评论管理</a></li>
              <li class="curr"><a href="KS.DiggList.aspx">Digg管理</a></li>
...
<div class="content-area">
 <div class="myTitle fl mr20">Digg管理</div>
 <div class="opnav">
    <ul>
    快速查看：
    ...
    <KS:KSGV ID="List" cssclass="CTable" runat="server" Width="99%" PagerType="CustomNumeric" OnRowDataBound="List_RowDataBound" AutoGenerateColumns="False" EmptyDataText="没用digg记录！" GridLines="None">
        <Columns>
            ...
            <itemtemplate>
            <a href="KS.Digg.aspx?ChannelID=<%# Eval("ChannelID") %>&infoid=<%# Eval("infoid") %>" class="link-color">详细记录</a> | 
            <a class="link-color" href="<%# Kesion.HtmlTags.BasicField.GetItemUrl(Convert.ToInt32(Eval("ChannelID")),Convert.ToInt32(Eval("InfoID"))) %>" target="_blank">浏览<%# MyCache.GetCacheModel(Convert.ToInt16(Eval("ChannelID")),5) %></a>
