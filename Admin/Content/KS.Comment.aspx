...
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
       <div id="manage_top" class="menu_top_fixed">
       	  <div id='go' class="quickSelect"><asp:DropDownList ID="S_ChannelID" runat="server">
           <asp:ListItem Value="0">---分模型搜索---</asp:ListItem>
           </asp:DropDownList></div>
           <ul class="titleTab"><li><strong>管理操作：</strong></li>
              <li class="curr"><a href="KS.Comment.aspx">评论管理</a></li>
              <li><a href="KS.DiggList.aspx">Digg管理</a></li>
              <li><a href="KS.Mood.aspx">表情管理</a></li>
           </ul>
       </div> 
        <div class="menu_top_fixed_height"></div> 
      <div class="content-area">
       <div class="myTitle">评论管理
...
<KS:KSGV ID="list" cssclass="CTable" runat="server"  AutoGenerateColumns="False" PagerType="CustomNumeric" Width="99%" EmptyDataText="没有任何评论！" GridLines="None" OnRowDataBound="list_RowDataBound" OnRowCommand="list_RowCommand" OnRowCreated="list_RowCreated" AllowPaging="false" >
          <Columns>
              ...
              <asp:TemplateField HeaderText="评论内容">
                  <itemtemplate>
                    ...
                    <span style="cursor:pointer" onmousedown='parent.openWin("查看评论详情","<%=KSCMS.GetInstallDir()+Kesion.Cache.MyCache.GetCacheConfig(4)%>/content/KS.CommentShow.aspx?ID="+<%# Eval("ID") %>,false);return false;'>
              ...
              <asp:TemplateField HeaderText="查看">
                    <itemstyle width="30px" horizontalalign="Center"/>
                                <itemtemplate>
             <a href="#" class="plicon" onclick='ShowComment(<%# Eval("ID") %>);return false;'></a>
                    </itemtemplate>
                </asp:TemplateField>
      ...
      <div class="listedit">
          <input type='checkbox' name='chkall' id='chkall' onClick='CheckAll(this.form);' /><label for="chkall">全部选中</label>
              <asp:LinkButton ID="vbt" CssClass="button" runat="server" OnClick="vbt_Click"><b></b>审核评论</asp:LinkButton>
              <asp:LinkButton ID="cvbt" CssClass="button" runat="server" OnClick="cvbt_Click"><b></b>取消审核</asp:LinkButton>
               <asp:LinkButton ID="dbt" CssClass="button" runat="server" OnClick="dbt_Click"><b></b>删除评论</asp:LinkButton>
                <%if (showType == 3)
                { %>
                   <asp:LinkButton ID="LinkButton1" runat="server" OnClientClick="return(GetIDS());" OnClick="Button3_Click"><b></b>批量设置正常评论</asp:LinkButton>
              <%} %>
           </div>   
      <script>
