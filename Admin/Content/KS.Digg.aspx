...
<div id="manage_top" class="toptitle menu_top_fixed">
    <ul>
        <li id="p9"><a href="KS.DiggList.aspx"><b></b>返回</a></li>
    </ul>
     
</div>
<div class="menu_top_fixed_height"></div> 
<div class="content-area">
	<div class="myTitle">查看详细推荐记录</div>
    <KS:KSGV ID="List" runat="server" Width="99%" CssClass="CTable" PagerType="CustomNumeric" OnRowDataBound="List_RowDataBound" AutoGenerateColumns="False" EmptyDataText="没用digg记录！" GridLines="None" OnRowCommand="List_RowCommand">
        <Columns>
            ...
            <itemtemplate>
            <a href="<%# Kesion.HtmlTags.BasicField.GetItemUrl(ChannelID,Convert.ToInt32(Eval("InfoID"))) %>" target="_blank" title="浏览<%=MyCache.GetCacheModel(ChannelID,5) %>" class="preview"></a>
               &nbsp; <asp:LinkButton runat="server" CommandName="del" CommandArgument='<%# Eval("id") %>' CssClass="delete" ToolTip="删除">删除</asp:LinkButton>      
            </itemtemplate>
            </asp:TemplateField>
        </Columns>
