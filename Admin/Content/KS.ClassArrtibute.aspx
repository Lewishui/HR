...
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
   ...
   <div class="content-area"> 
    ...
    <tr class="tdbg">
      <td vAlign=top width=200 style="padding-right:15px;">
...
<div class="br"></div>
   ...
   <input onclick="SelectAll()" type="button" class="button" value="选定所有栏目" name="Submit" /><div class="br"></div>
			...
			<script type="text/javascript">
                      ...
                      <tr>
                          ...
                          <td class="righttd">
                              ...
                              会员每发表一条信息，可以得到 <asp:TextBox ID="PubAddPoint" CssClass="textbox" runat="server" Style="text-align: center"
                                  Text="0" Width="37px"></asp:TextBox>点点券（为0时不奖励）<span class="tips">只有通过后台审核的才增加</span>
                ...
                <tr>
				  ...
				  <tr>
					...
					<td height='30' align='right' class='lefttd' style="width: 186px"><strong>PC栏目模板：</strong> </td>
					<td height='28' class="righttd">
					  <input type="text" name='ClassTemplate' class="textbox" id="ClassTemplate" size='35'/>&nbsp;<input type='button' name="Submit" class="button" value="选择模板..." onclick="SelectTemplate('ClassTemplate',0);" />
				    </td>
				 </tr>
                 <tr<%=MyCache.GetCacheConfig(72)=="0"?" style='display:none'":"" %>>
					...
					<td height='28' class="righttd">
					  <input type="text" name='Class3GTemplate' class="textbox" id="Class3GTemplate" size='35'/>&nbsp;<input type='button' name="Submit" class="button" value="选择模板..." onclick="SelectTemplate('Class3GTemplate',1);" />
				    </td>
				 </tr>
				 <tr>
				   <td align='center' class='lefttd' style="width: 52px; height: 30px;"><asp:CheckBox ID="C7" runat="server" /></td>
				   <td align='right'  class='lefttd' style="width: 186px; height: 30px;"><strong>PC内容页模板：</strong></td>
				   <td class="righttd" style="height: 30px">
					  <input type="text" name='ContentTemplate' class="textbox" id="ContentTemplate" size='35' />&nbsp;<input type='button' name="Submit" class="button" value="选择模板..." onclick="SelectTemplate('ContentTemplate',0);" />  
					  <div class="tips">
				  ...
				  <tr<%=MyCache.GetCacheConfig(72)=="0"?" style='display:none'":"" %>>
				   ...
				   <td class="righttd" style="height: 30px">
					  <input type="text" name='Content3GTemplate' class="textbox" id="Content3GTemplate" size='35' />&nbsp;<input type='button' name="Submit" class="button" value="选择模板..." onclick="SelectTemplate('Content3GTemplate',1);" />  
					  <div class="tips">
			...
			<script type="text/javascript">
              ...
              <table width="100%" border="0" cellpadding="1" cellspacing="1" class="CTable">
                <tr>
                  ...
                  <tbody id="fsoclassindx"<%=KSCMS.S("from").Equals("shop")?" style='display:none'":string.Empty %>>
                  <tr>
                      <td align="center" class="lefttd" style="width: 50px">
                  ...
                  <tr>
                      <td align="center" class="lefttd" style="width: 50px">
                          <asp:CheckBox ID="F6" runat="server" /></td>
                      <td align="right" class="lefttd" style="width: 181px">
                          <strong>栏目生成路径规则：</strong></td>
                      <td class="righttd">
                         <asp:RadioButtonList runat="server" ID="RdbClassFsoDirRule" RepeatLayout="Flow">
                   ...
                   <tr>
                      <td align="center" class="lefttd" style="width: 50px">
                          <asp:CheckBox ID="F7" runat="server" /></td>
                      <td align="right" class="lefttd" style="width: 181px">
                          <strong>生成的栏目自定义前缀：</strong></td>
                      <td class="righttd">
                  ...
                  <tr>
                      ...
                      <td class="righttd">
                          <asp:TextBox ID="CreateInfoPath" CssClass="textbox" runat="server" Text="{$ClassDir}/" Width="283px"></asp:TextBox><span class="tips">必须与＂/＂结束</span><div class="br"></div>
                          <select name="SelectInfoFsoPath" onchange="if (this.value!=''){jQuery('#<%=this.CreateInfoPath.ClientID %>').val(this.value);}" style="width:297px">
                  ...
                  <tr>
                      ...
                      <td class="righttd" style="height: 57px">
                          <asp:TextBox ID="CretaeInfoFname" CssClass="textbox" runat="server" Text="{$InfoID}.html" Width="283px"></asp:TextBox><div class="br"></div>
                          <select name="SelectInfoName" onchange="if (this.value!=''){jQuery('#<%=this.CretaeInfoFname.ClientID %>').val(this.value);}" style="width:297px;">
