...
<asp:Panel ID="listPanel" runat="server" Width="100%">
    <div id="manage_top" class="menu_top_fixed">
         <ul class="titleTab"><li><strong>管理操作：</strong></li>
          ...
          <li class="curr"><a href="KS.CopyFrom.aspx">来源管理</a></li>
   ...
   <div class="content-area"> 
	  <div class="myTitle">
      	来源管理
      	<span class="fr">
        	<asp:LinkButton ID="addcopyfrom" CssClass="button" runat="server" OnClick="addcopyfrom_Click">添加来源</asp:LinkButton>
        </span>
      </div>
      ...
      <div class="listedit">
          ...
          <asp:LinkButton ID="editcopyfrom" CssClass="button" runat="server" OnClick="editcopyfrom_Click">编辑来源</asp:LinkButton>
          <asp:LinkButton ID="delcopyfrom" CssClass="button" runat="server" OnClick="delcopyfrom_Click">删除来源</asp:LinkButton>
     </div>
