...
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
    ...
    <div id="manage_top" class="menu_top_fixed">
         <ul class="titleTab"><li><strong>管理操作：</strong></li>
          <li class="curr"><a href="KS.Author.aspx">作者管理</a></li>
          <li><a href="KS.CopyFrom.aspx">来源管理</a></li>
          <li><a href="KS.KeyTags.aspx">关键字管理</a></li>
       </ul>
   </div>  
<div class="menu_top_fixed_height"></div> 
<div class="content-area">
	<div class="myTitle">
      <span class="fr"><asp:LinkButton ID="addauthor" CssClass="button" runat="server" OnClick="addauthor_Click">添加作者</asp:LinkButton></span>
    	作者管理
    </div>
      ...
      <div class="listedit">
          ...
          <asp:LinkButton ID="editauthor" CssClass="button" runat="server" OnClick="editauthor_Click">编辑作者</asp:LinkButton>
          <asp:LinkButton ID="delauthor" CssClass="button" runat="server" OnClick="delauthor_Click"><b></b>删除作者</asp:LinkButton>
      </div>
