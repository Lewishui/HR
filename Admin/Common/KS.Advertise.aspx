...
<tbody id="TimeArea" style="display:none">
	   ...
	   <tr>
            ...
            <td class="righttd" style="height: 30px">&nbsp;<asp:ListBox ID="BoardID" runat="server" SelectionMode="Multiple" style="width:380px;height:120px;"></asp:ListBox>
                <span class="tips">  <a class="textarea_min" href="javascript:zoomtextarea(-2,'<%=this.BoardID.ClientID %>');"> </a>
                               <a class="textarea_max" href="javascript:zoomtextarea(2,'<%=this.BoardID.ClientID %>');"></a>  Tips:一个广告条可以归属多个广告位，按Ctrl键可以多选。</span>
        ...
        <tr>
            ...
            <div class="colmn">
                链接地址<asp:TextBox  CssClass="textbox" ID="LinkUrl" runat="server" Width="227px"></asp:TextBox><span class="tips">对flash广告无效,只展示不链接的广告请留空</span></div>
                <div class="colmn">
                链接提示<asp:TextBox  CssClass="textbox" ID="LinkTips" runat="server" Width="227px"></asp:TextBox></div>
                <div class="colmn">
        ...
        <tr>
            ...
            <td class="righttd" style="height: 30px">
                ...
                <table cellspacing="0" cellpadding="0"><tr><td><asp:TextBox  CssClass="textbox" ID="PicUrl" runat="server" Width="227px"></asp:TextBox>&nbsp;<input type="button" class="button" onclick="SelectFiles('<%=this.PicUrl.ClientID %>',4);" value="选择图片"></td>
                            <%if (Kesion.BLL.KSSecurity.CheckCommonUploadPower()){ %>
                            <td style="padding-left:4px;padding-top:12px;"> <%=Kesion.APPCode.UploadAPI.EchoUpload("classpic",this.PicUrl.ClientID,150) %></td>
                            <%} %>
                            <td><img id="show<%=PicUrl.ClientID %>" src="<%=PicUrl.Text%>" width="60" height="60" style="border:1px solid #f1f1f1;" onerror="this.src='../../sysimg/nopic.gif'"/></td>
                          </tr>
                </table>
                 </td>
        </tr>
