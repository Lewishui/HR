    ...
    <table cellpadding="0" cellspacing="0" style="width: 100%">
            <tr>
                <td style="height: 25px">
                   ...
                   &nbsp;<asp:Button runat="server" ID="BtnDel" Text="批量删除" CssClass="button" onclick="BtnDel_Click" />
                   &nbsp;<asp:Button runat="server" ID="Button3" Text="批量采纳" CssClass="button" onclick="Button3_Click" />
                   &nbsp;<asp:Button runat="server" ID="Button4" Text="批量作废" CssClass="button" onclick="Button4_Click" />
                    <%if (isPay == 1)
                        { %>
                   &nbsp;<asp:Button runat="server" ID="Button5" Text="设置已支付" CssClass="button" OnClick="Button5_Click"  />
                   &nbsp;<asp:Button runat="server" ID="Button6" Text="设置未支付" CssClass="button" OnClick="Button6_Click"/>
                    <%} %>
