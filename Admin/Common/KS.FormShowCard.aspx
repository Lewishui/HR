         ...
         <ItemTemplate>
                   ...
                   <tr>
                        ...
                        <td align="left" class="righttd">
                              ...
                              <%if (isPay == 1)
                                  { %>
                              | <a href="KS.FormShowCard.aspx?action=paystatus&formid=<%=formid %>&ids=<%# Eval("RecordID") %>&v=1">已支付</a>  
                              | <a href="KS.FormShowCard.aspx?action=paystatus&formid=<%=formid %>&ids=<%# Eval("RecordID") %>&v=0">未支付</a>  
                              <%}
                                  if (isReply==1) { %>
