            ...
            <asp:TemplateField HeaderText="状态">
              ...
              <itemtemplate>
               ...
               <asp:TemplateField HeaderText="内容">
                <ItemTemplate>
                <span style="cursor:pointer" onmousedown='parent.openWin("查看PK观点详情","<%=KSCMS.GetInstallDir()+Kesion.Cache.MyCache.GetCacheConfig(4)%>/common/KS.PKGDShow.aspx?ID="+<%# Eval("ID") %>,false,800,450);return false;'><%# Utils.GetSubString(Convert.ToString(Eval("Content")), 40, "...") %></span>
                </ItemTemplate>
               </asp:TemplateField>
