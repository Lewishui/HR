...
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
    <asp:Panel ID="listPanel" runat="server" Width="100%">
        <KS:OrderJS ID="OrderJS1" runat="server" />
         ...
         <div id="go" class="quickSelect"><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label></div>
              <ul>
          ...
          <li id='p9'><b></b><asp:LinkButton ID="backbutton" runat="server" OnClick="backbutton_Click">回上一级</asp:LinkButton></li>
