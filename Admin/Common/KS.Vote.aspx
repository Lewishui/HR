    ...
    <div class="content-area">    
        <table width="99%" align="center" border="0" cellpadding="1" cellspacing="1" class="CTable"> 
          <tr>
            ...
            <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="margin-left:5px;" width="80%">
                 ...
                 <tr>
                  ...
                  投票扩展数量: 
              <input name="vote_num" class="textbox" type="text" id="votenum" value="1" size="5" style="width:40px;text-align:center"> 
            ...
            <tr>
                <td align="right" class="lefttd" height="30" style="width: 150px">
                    <strong>参与投票赠送积分：</strong></td>
                <td class="righttd">
                <asp:TextBox ID="TxtVoteScore" runat="server" Text="0" Width="50" CssClass="textbox" style="text-align:center" />
                    <span class="tips">Tips:不赠送请填“0”。</span>
                </td>
            </tr>
          </table>
          <br />
