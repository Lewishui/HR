...
<div class="content-area">  
    ...
    <KS:KSGV ID="list" cssclass="CTable" runat="server" EmptyDataText="还没有添加任何的广告位!" GridLines="None" Width="99%" AutoGenerateColumns="False" OnRowDataBound="list_RowDataBound" PagerType="CustomNumeric" OnRowEditing="list_RowEditing" OnRowCommand="list_RowCommand" OnRowDeleting="list_RowDeleting" OnRowCreated="list_RowCreated">
       <Columns>
           ...
           <asp:TemplateField HeaderText="↓生成JS">
               ...
               <itemtemplate>
                <asp:LinkButton runat="server" CommandName="createjs" CausesValidation="False" CommandArgument='<%#Eval("boardid") %>' CssClass="link-color" id="LinkButtonFso">生成</asp:LinkButton>
                </itemtemplate>
           </asp:TemplateField>
        </Columns>
    ...
    <asp:Panel ID="Panel1" runat="server" Height="30px">
              <div style="margin-top:15px;overflow:hidden;"></div>
            选中的广告位移动到分类:
                  
               &nbsp; <asp:DropDownList ID="RdbMoveClassID" runat="server"></asp:DropDownList>
               <asp:Button ID="ExecuteButton" CssClass="button" runat="server" Text="开始执行" OnClick="ExecuteButton_Click" />
</asp:Panel>
