            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="查看详细记录">
                 ...
                 <itemtemplate>
                   ...
                   <asp:LinkButton runat="server" id="viewcard" commandargument=<%#Eval("formid") %> commandname="viewcard" CssClass="link-color">卡片式查看</asp:LinkButton>
                   <asp:LinkButton runat="server" id="viewdetail" commandargument=<%#Eval("formid") %> commandname="viewdetail" CssClass="link-color">查看详情(横排)</asp:LinkButton>
                   <asp:LinkButton runat="server" id="viewentrants" commandargument=<%#Eval("formid") %> commandname="viewentrants" CssClass="link-color">查看详情(竖排)</asp:LinkButton>
