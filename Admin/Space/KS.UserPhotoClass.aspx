...
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
    ...
    <div id="manage_top">
       <ul>
           <li id='p1'><asp:LinkButton ID="addclassbutton" runat="server" OnClick="addclassbutton_Click"><b></b>添加相册分类</asp:LinkButton></li><div id="go">
    ...
    <KS:ksgv id="List" runat="server" AutoGenerateColumns="False" cssClass="CTable" EmptyDataText="还没有任何相册分类!" PagerType="CustomNumeric" Width="99%" HorizontalAlign="center" GridLines="None" OnRowDataBound="List_RowDataBound" OnRowCommand="List_RowCommand" OnRowCreated="List_RowCreated" >
        <Columns>
...
<asp:Panel ID="Panel1" runat="server" Height="30px" Width="741px">
    ...
    <asp:Panel ID="AddPanel" runat="server" Width="100%" Visible="false">
        <KS:TopNav ID="TopNav1" runat="server" Text="添加相册分类" />
     <div class="content-area">   
