...
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
    ...
    <div id="manage_top" class="menu_top_fixed">
       <ul>
           <li id='p1'><asp:LinkButton ID="addclassbutton" runat="server" OnClick="addclassbutton_Click"><b></b>添加日志分类</asp:LinkButton></li><div id="go">
   ...
   <div class="content-area">
    <KS:ksgv id="List" runat="server" CssClass="CTable"  AutoGenerateColumns="False" EmptyDataText="还没有任何日志分类!" PagerType="CustomNumeric" Width="99%" GridLines="None" OnRowDataBound="List_RowDataBound" OnRowCommand="List_RowCommand" OnRowCreated="List_RowCreated" >
        <Columns>
...
<asp:Panel ID="Panel1" runat="server" Height="30px" Width="741px">
    ...
    <asp:Panel ID="AddPanel" runat="server" Width="100%" Visible="false">
        <KS:TopNav ID="TopNav1" runat="server" Text="添加日志分类" />
    <div class="content-area">    
