...
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
    ...
    <table id="tbs" width="100%" border="0" cellpadding="1" cellspacing="1" class="CTable"> 
        ...
        <tr>
            ...
            <td class="righttd">
                博文列表显示<asp:TextBox CssClass="textbox" Text="8" ID="BlogArticleList" runat="server" Width="50" Style="border:none;border-bottom:1px solid #DDD; text-align:center;"></asp:TextBox>；
                相册列表显示<asp:TextBox CssClass="textbox" Text="8" ID="BlogAlbumList" runat="server" Width="50" Style="border:none;border-bottom:1px solid #DDD; text-align:center;"></asp:TextBox>；
                文集列表显示<asp:TextBox CssClass="textbox" Text="8" ID="BlogCorpusList" runat="server" Width="50" Style="border:none;border-bottom:1px solid #DDD; text-align:center;"></asp:TextBox>；
                问答列表显示<asp:TextBox CssClass="textbox" Text="8" ID="BlogAskList" runat="server" Width="50" Style="border:none;border-bottom:1px solid #DDD; text-align:center;"></asp:TextBox>
        </tr>
        <tr>
            <td align="right" class="lefttd" height="30" style="width: 198px">
                <strong>空间Logo图片属性：</strong></td>
            <td class="righttd">
                限制上传大小<asp:TextBox CssClass="textbox" Text="1000" ID="BlogLogoSize" runat="server" Width="50" Style="border:none;border-bottom:1px solid #DDD; text-align:center;"></asp:TextBox>kb；
                限制图片扩展名<asp:TextBox CssClass="textbox" Text="jpg|png|gif" ID="BlogLogoExt" runat="server" Width="150" Style="border:none;border-bottom:1px solid #DDD; text-align:center;"></asp:TextBox>；
        </tr>
        ...
        <tr>
            ...
            <td class="righttd">
                发表日志要求达到<asp:TextBox CssClass="textbox" Text="0" ID="BlogArticleCredits" runat="server" Width="50" Style="border:none;border-bottom:1px solid #ddd; text-align:center;"></asp:TextBox>分积分；
                上传照片要求达到<asp:TextBox CssClass="textbox" Text="0" ID="BlogAlbumCredits" runat="server" Width="50" Style="border:none;border-bottom:1px solid #ddd; text-align:center;"></asp:TextBox>分积分。
        </tr>
        ...
        <tr>
            ...
            <td class="righttd">
                允许上传的附件扩展名<asp:TextBox CssClass="textbox" Text="gif | jpg | rar" ID="BlogArticleFileExt" runat="server" Width="100" Style="border:none;border-bottom:1px solid #ddd;text-align:center;"></asp:TextBox>多个扩展名用 |隔开,如gif|jpg|rar等<br />
                允许上传的文件大小<asp:TextBox CssClass="textbox" Text="1000" ID="BlogArticleFileSize" runat="server" Width="50" Style="border:none;border-bottom:1px solid #ddd;"></asp:TextBox>KB<br />
        ...
        <tr>
         ...
         <tr>
            ...
            <td class="righttd">
                允许上传的文件大小<asp:TextBox CssClass="textbox" ID="BlogAlbumFileSize" Text="1000" runat="server" Width="50" Style="border:none;border-bottom:1px solid #ddd;"></asp:TextBox>KB<br />
        </tr>
