...
<div class="content-area">
    <table width="100%" border="0" cellpadding="1" cellspacing="1" class="CTable">
        ...
        <tr>
            ...
            <td class="righttd">
                &nbsp;<asp:TextBox CssClass="textbox" ID="txtTags" runat="server" Width="300px"></asp:TextBox><span class="link-operate"><a href="javascript:GetKeyTags();">自动获得关键字Tag</a></span>
                </td>
        </tr>
        <tr>
            <td align="right" class="lefttd">
...
<td>&nbsp;<button type="button"  class="button" onclick="OnlineCollect('content/')" style="margin: -6px 0px 0 0;">网上采集</button> <button type="button"  class="button" onClick="AddTJ('content/');" style="margin: -6px 0px 0 0;">图片库...</button></td>
    ...
    <script type="text/javascript" >
        ...
        <div class="main-button">
            <asp:Button ID="Button1" OnClientClick="return(CheckForm());" CssClass="button" runat="server" Text="OK!确定保存" OnClick="Button1_Click" /><input type="button" onclick="history.go(-1)" class="button" value=" 返 回 " />
        </div>
    </asp:Panel>
  </div>
</asp:Content>
