...
//-->    
 ...
 <div class="myTitle">
  ...
  <div class="tabs_header">
    ...
    <KS:ksgv id="List" cssclass="CTable" runat="server" AutoGenerateColumns="False" EmptyDataText="没有博文记录!" PagerType="CustomNumeric" Width="99%" HorizontalAlign="left" GridLines="None" OnRowDataBound="List_RowDataBound" OnRowCommand="List_RowCommand" OnRowCreated="List_RowCreated" >
            <Columns>
...
<asp:Panel runat="server" ID="editPanel" Visible="false">
 ...
 <div class="content-area">       
    <table  cellspacing="1" cellpadding="3" class="CTable" width="100%" align="center" border="0">
            ...
            <td><asp:TextBox ID="txtBlogName"  CssClass="textbox"  runat="server" Width="400"></asp:TextBox><span class="tips"></span>
            ...
            <td><asp:TextBox ID="txtAddDate" ReadOnly="true" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});" CssClass="textbox Wdate" runat="server" Width="200"></asp:TextBox><span class="tips">博文日期</span>
            <span style="color: red">* 
                </span></td>
            </tr>
            ...
            <td>
                ...
                <asp:TextBox ID="textContent" TextMode="multiLine" style="width:98%;height:250px" runat="server"></asp:TextBox>
...
<div class="main-button">
      <asp:Button OnClientClick="return(CheckForm2());" ID="Button2" CssClass="button" runat="server" OnClick="Button2_Click"
          Text="OK!确定修改" />
      <input type="button" onclick="history.go(-1)" class="button" value=" 返回 " /></div>
