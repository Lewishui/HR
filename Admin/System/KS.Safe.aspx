...
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
    ...
    <table id="tbs" width="99%" border="0" cellpadding="1" cellspacing="1" class="CTable"> 
        ...
        <tr>
            ...
            <div class="tips">
             启用此功能，请确保在<a href="KS.SMSAPI.aspx" class="link-color">[短信接口API配置]</a>里有可用的接口短信，并且有可用短信余额。
        ...
        <tr>
            ...
            <td class="righttd">
               ...
               <tr>
                 ...
                 <input type="checkbox" name="code11" id="v11" onclick="checkselecedpage()"/><label for="v11">在线留言</label>
...
function loadseccodestatus()
{
    ...
    if (seccodestatus.indexOf('plus/message.aspx') >= 0) {
        document.getElementById("v11").checked = true;
    }
