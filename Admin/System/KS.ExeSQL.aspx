...
<%@ Register TagPrefix="KS" Namespace="Kesion.Controls" Assembly="Kesion.APPCode" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
    ...
    <div class="content-area">
        ...
        <asp:Panel ID="Panel1" runat="server" Height="25px" Width="100%" CssClass="lefttd">
         ...
         <br />
        <asp:Panel ID="listresult" runat="server" Height="372px" Width="100%" style="overflow:auto;">
