 ...
 <!--
   ...
   function showfsotime() {
    ...
    function showLoginType() {
      if (jQuery("#<%=this.RdbUserNameType.ClientID %> :radio[checked]").val() == "0") {
            jQuery("#showregbyusername").show();
       } else {
            jQuery("#showregbyusername").hide();
       }
    }
    function showPoint(){
        if (jQuery("#<%=this.RdbIsPoint.ClientID %> :radio[checked]").val() == "1") {
            jQuery("#showpoint").show();
       } else {
            jQuery("#showpoint").hide();
       }
    }
   ...
   <div class="content-area">
		<div class="tab-page" id="SystemPanel">
		 ...
		 <div class="tab-page" id="tab0">
                            ...
                            <tr>
                              <td  height="30" align="right" class="lefttd" style="width: 198px"><b>网站域名：</b></td>
                                              ...
                                              <tr>
                                                ...
                                                <td class="righttd"> <table cellspacing="0" cellpadding="0"><tr><td><asp:TextBox CssClass="textbox" Width="350" ID="WebLogo" runat="server"></asp:TextBox>&nbsp;<input type="button" class="button" onclick="SelectFiles('<%=this.WebLogo.ClientID %>',0);" value="选择Logo..."></td>
                                                          <%if (Kesion.BLL.KSSecurity.CheckCommonUploadPower()) { %>
                                                                <td style="padding-left:4px;padding-top:15px; vertical-align:middle;*padding-top:12px; "> <%=Kesion.APPCode.UploadAPI.EchoUpload("classpic", this.WebLogo.ClientID, 150) %></td>
                                                            <%} %>
                                                                <td><img id="show<%=WebLogo.ClientID %>" src="<%=WebLogo.Text%>"  height="30" style="border:1px solid #f1f1f1;" onerror="this.src='../../sysimg/nopic.gif'"/></td>
                                                              </tr>
                                                    </table>
                                                </td>
                                              </tr>
                                              <tr>
                                                ...
                                                <tr>
                                                     ...
                                                     <td class="righttd"><asp:RadioButtonList ID="SpecialFsoTF" runat="server" RepeatDirection="Horizontal" BorderStyle="None" RepeatLayout="Flow">
                                                 ...
                                                 <tr>
                                                     ...
                                                     <tr>
                                                         ...
                                                         <td class="righttd"><asp:TextBox CssClass="textbox textarea" Width="350"  Height="100" ID="CopyRight" runat="server" TextMode="MultiLine" Columns="50" Rows="4"></asp:TextBox>
                                                               ...
                                                               <a class="textarea_max" href="javascript:zoomtextarea(5,'<%=this.CopyRight.ClientID %>');"></a>
		  ...
		  <h2 class="tab" style="display:none">手机版设置</h2>
			<script type="text/javascript">
			    tabPane1.addTabPage(document.getElementById("3gtab"));
			</script>
             <table width="100%" style="display:none" border="0" cellpadding="1" cellspacing="1" class="CTable"> 
                 <tr>
			...
			<script type="text/javascript">
             ...
             <table width="100%"  border="0" cellpadding="1" cellspacing="1" class="CTable"> 
                             ...
                             <tr>
                                 ...
                                 <td class="righttd"><asp:TextBox Width="450"  Height="100" CssClass="textbox textarea" ID="TxtMetaKeywords" runat="server" TextMode="MultiLine" Columns="50" Rows="5"></asp:TextBox>
                                     <a class="textarea_min" href="javascript:zoomtextarea(-5,'<%=this.TxtMetaKeywords.ClientID %>');"></a>
                                     <a class="textarea_max" href="javascript:zoomtextarea(5,'<%=this.TxtMetaKeywords.ClientID %>');"></a>
                                     <br />
                                    <span class="tips">
                             ...
                             <tr>
                                 ...
                                 <td class="righttd"><asp:TextBox Width="450" Height="100" CssClass="textbox textarea" ID="TxtMetaDescript" runat="server" TextMode="MultiLine" Columns="50" Rows="5"></asp:TextBox>
                                      <a class="textarea_min" href="javascript:zoomtextarea(-5,'<%=this.TxtMetaDescript.ClientID %>');"></a>
                                      <a class="textarea_max" href="javascript:zoomtextarea(5,'<%=this.TxtMetaDescript.ClientID %>');"></a>
                                     <br />
        ...
        <table width="100%"  border="0" cellpadding="1" cellspacing="1" class="CTable"> 
                      ...
                      <tr>
                       ...
                       <a href="<%=BasicField.GetRewriteUrl("specialindex") %>" target="_blank"><font color=green>(special/index.aspx)</font></a> </td>
                      </tr>               
                        ...
                        <tr>
                          ...
                          <td class="righttd" style="height: 30px">
                            ...
                            <a href="<%=BasicField.GetRewriteUrl("search") %>?key=kesion" target="_blank"><font color=green>(plus/Search.aspx)</font></a></td>
                      </tr>
                         ...
                         <tr>
                            ...
                            <td class="righttd">
                              ...
                              <span class="tips">如需修改会员中心首页模板，请直接用编辑工具打开“/User/User.master”进行修改。</span>
                                 ...
                                 <a href="<%=BasicField.GetRewriteUrl("reg") %>" target="_blank"><font color=green>(user/UserReg.aspx)</font></a>
                                </div>
                        ...
                        <tr>
                            ...
                            <td class="righttd">
                               <div class="tips">公告列表模板：“/<%=MyCache.GetCacheConfig(13) %>/Common/announcelist.html”。
                                <a href="<%=BasicField.GetRewriteUrl("announce") %>" target="_blank"><font color=green>(/plus/announce.aspx)</font></a>
                                </div>
                                <div class="tips">显示公告模板(普通）：“/<%=MyCache.GetCacheConfig(13) %>/Common/announce.html”。
                                <a href="<%=BasicField.GetRewriteUrl("announce") %>?newest=1" target="_blank"><font color=green>(/plus/announce.aspx?newest=1)</font></a>
                                </div>   
                                <div class="tips">显示公告模板(弹窗）：“/<%=MyCache.GetCacheConfig(13) %>/Common/openannounce.html”。
                                <a href="<%=BasicField.GetRewriteUrl("announce") %>?showtype=1&newest=1" target="_blank"><font color=green>(/plus/announce.aspx?showtype=1&newest=1)</font></a>
                                </div>   
                        ...
                        <tr>
                            ...
                            <td class="righttd">
                               <div class="tips">友情链接首页模板：“/<%=MyCache.GetCacheConfig(13) %>/Common/linkindex.html”。
                                <a href="<%=BasicField.GetRewriteUrl("link") %>" target="_blank"><font color=green>(/plus/link/index.aspx)</font></a>
                                </div>
                                <div class="tips">友情链接申请模板：“/<%=MyCache.GetCacheConfig(13) %>/Common/linkapply.html”。
                                <a href="<%=BasicField.GetRewriteUrl("linkapply") %>" target="_blank"><font color=green>(/plus/link/apply.aspx)</font></a>
                                </div>   
                         ...
                         <tr>
                            ...
                            <td class="righttd">
                                ...
                                <a href="<%=BasicField.GetRewriteUrl("tags") %>" target="_blank"><font color=green>(/Plus/Tags.aspx)</font></a>
                                </div>
                                <div class="tips">Tags列表模板：“/<%=MyCache.GetCacheConfig(13) %>/Common/tagslist.html”。
                                <a href="<%=BasicField.GetRewriteUrl("tags") %>?key=kesion" target="_blank"><font color=green>(/Plus/Tags.aspx)</font></a>
                                </div>
                                <div class="tips">网站地图模板：“/<%=MyCache.GetCacheConfig(13) %>/Common/map.html”。
                                <a href="<%=BasicField.GetRewriteUrl("map") %>" target="_blank"><font color=green>(/plus/map.aspx)</font></a>
                                </div>
...
<table  width="100%" border="0" cellpadding="1" cellspacing="1" class="CTable"> 
              ...
              <tr>
               ...
               <tr>
                   ...
                   <td class="righttd">
                       <asp:TextBox CssClass="textbox textarea" Height="120" Width="750" ID="UserLience" runat="server" Columns="60" Rows="6" TextMode="MultiLine"></asp:TextBox>
            ...
            <tr>
                   <td align="right" class="lefttd" height="30" style="width: 198px">
                       <strong>会员注册IP限制：</strong></td>
                   <td class="righttd">每个IP每天只能注册
                       <asp:TextBox ID="TxtIPNum" Text="0" runat="server" CssClass="textbox" style="text-align:center;width:50px;" />
                       个账号
          ...
          <tr>
                   <td align="right" class="lefttd" height="30" style="width: 198px">
                       <strong>会员名称构成：</strong></td>
                   <td class="righttd"><asp:RadioButtonList ID="RdbUserNameType" runat="server" RepeatLayout="Flow">
                       <asp:ListItem Value="0" Selected="True">普通用户名</asp:ListItem>
                       <asp:ListItem Value="1">仅限手机号(快速注册模式)</asp:ListItem>
                       <asp:ListItem Value="2">仅限电子Email(快速注册模式)</asp:ListItem>
                       <asp:ListItem Value="3">手机号及电子Email均可(快速注册模式)</asp:ListItem>
                   </asp:RadioButtonList>

                       <div class="tips">Tips:会员名称构成格式一旦设置，不建议修改。</div>
                   </td>
            </tr>
           <tr>
                  <td align="right" class="lefttd" style="width: 198px; height: 30px">
                      <strong>注册启用选项：</strong></td>
                  <td class="righttd" style="height: 30px"><asp:CheckBoxList ID="CkbEnabledRegField" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" RepeatColumns="8">
                      ...
                      <div class="tips">Tips:除“启用用户组注册”外，其它的仅会员名称构成方式为“普通用户名”才有效。</div>
                   </td>
              </tr>

            <tbody id="showregbyusername">
             <tr>
                   <td align="right" class="lefttd" height="30" style="width: 198px">
                       <strong>会员登录方式：</strong></td>
                   <td class="righttd"><asp:RadioButtonList ID="RdbLoginType" runat="server" RepeatLayout="Flow">
                       <asp:ListItem Value="0" Selected="True">普通用户名/UID</asp:ListItem>
                       <asp:ListItem Value="1">仅限手机号</asp:ListItem>
                       <asp:ListItem Value="2">仅限电子Email</asp:ListItem>
                       <asp:ListItem Value="3">手机号及电子Email均可（推荐）</asp:ListItem>
                       <asp:ListItem Value="4">普通用户名/UID、手机号及电子Email均可(不推荐)</asp:ListItem>
                   </asp:RadioButtonList>
                        <div class="tips">Tips:会员登录方式一旦设置，不建议修改。</div>
                   </td>
               </tr>
               ...
               <tr>
                ...
                <tr>
                   <td align="right" class="lefttd" height="30" style="width: 198px">
                       <strong>新用户注册用户名是否允许用纯数字：</strong></td>
                   <td class="righttd">
                       <asp:RadioButtonList ID="RdbRegUserNameHasNum" runat="server" RepeatLayout="Flow" RepeatDirection="Horizontal">
                ...
                <tr>
                   <td align="right" class="lefttd" height="30" style="width: 198px">
                       <strong>新用户注册用户名是否允许含有中文：</strong></td>
                   <td class="righttd">
                       <asp:RadioButtonList ID="RdbRegUserNameHasCN" runat="server" RepeatLayout="Flow" RepeatDirection="Horizontal">
                           <asp:ListItem Value="0" selected="True">不允许</asp:ListItem>
                           <asp:ListItem Value="1">允许</asp:ListItem>
                       </asp:RadioButtonList>
                   </td>
               ...
               <tr>
                   ...
                   <td class="righttd">
                       <asp:TextBox CssClass="textbox textarea" ID="NoAllowRegUserName" style="width:650px;height:60px;" runat="server" Columns="60" Rows="2" TextMode="MultiLine"></asp:TextBox>
              ...
              <tr>
                   ...
                   <td class="righttd"><asp:RadioButtonList ID="UserEmailMutiRegTF" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                       ...
                       <span class="tips">Tips:登录方式启用Email登录时，建议设置为“否”。</span>
               ...
               <tr>
                   <td align="right" class="lefttd" height="30" style="width: 198px">
                       <strong>每个手机号是否允许注册多次：</strong></td>
                   <td class="righttd"><asp:RadioButtonList ID="RdbMobileMutiRegTF" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                       <asp:ListItem Value="1" Selected="True">是</asp:ListItem>
                       <asp:ListItem Value="0">否</asp:ListItem>
                   </asp:RadioButtonList>

                       <span class="tips">Tips:登录方式启用手机号登录时，建议设置为“否”。</span>
                   </td>
               </tr> 
        </tbody>
               <tr>
                   <td align="right" class="lefttd" height="30" style="width: 198px">
                       <strong>会员帐号登录限制：</strong></td>
                   <td class="righttd">
                      <asp:RadioButtonList ID="UserMutiLoginTF" runat="server" RepeatLayout="Flow">
                           <asp:ListItem Value="0">不限制</asp:ListItem>
                           <asp:ListItem Value="1" Selected="True">同个会员账号只能在一个PC端及一个移动端登录</asp:ListItem>
                           <asp:ListItem Value="2" Selected="True">无论PC端还是移动端同个账号都只能一个地方登录（推荐）</asp:ListItem>
                       </asp:RadioButtonList></td>
               </tr>
               <tr>
                   <td align="right" class="lefttd" style="width: 198px; height: 30px;">
                   ...
                   <td class="righttd" style="height: 30px">
                       会员每隔<asp:TextBox CssClass="textbox" ID="UserPerMinLogin" runat="server" Width="43px"></asp:TextBox>分钟后 重新登录奖励<asp:TextBox CssClass="textbox"  
                           ID="UserPerMinAddScore" runat="server" Width="36px"></asp:TextBox>分积分
                    <span class="tips">提示：建议设置1440分钟(一天)，设置为“0”将不启用登录赠送积分功能。</span>
                   </td>
               </tr>
               ...
               <tr>
                   ...
                   <td class="righttd">
                       <asp:TextBox CssClass="textbox textarea" Height="120" Width="650" ID="TxtRegSuccMail" runat="server" Columns="60" Rows="6" TextMode="MultiLine"></asp:TextBox>
                       <a class="textarea_min" href="javascript:zoomtextarea(-5,'<%=this.TxtRegSuccMail.ClientID %>');"></a> 
                       <a class="textarea_max" href="javascript:zoomtextarea(5,'<%=this.TxtRegSuccMail.ClientID %>');"></a>
                       <br /> Tips:内容留空将不发送！！！
                   </td>
               </tr>
               ...
               <tr>
                   <td align="right" class="lefttd" height="30" style="width: 198px">
                       <strong>新会员成功注册赠送：</strong></td>
                   <td class="righttd">
                      赠送资金 <asp:TextBox CssClass="textbox" ID="UserRegAddMoney" runat="server" Width="55px"></asp:TextBox>元
                       赠送积分：<asp:TextBox CssClass="textbox" ID="UserRegAddScore" Text="0" runat="server" Width="55px"></asp:TextBox>分
                       赠送点券：<asp:TextBox CssClass="textbox" ID="UserRegAddPoint" Text="0" runat="server" Width="55px"></asp:TextBox>点
                       <span class="tips">Tips:设置为0时不赠送</span>
                   </td>
               </tr>

                <tr>
                   <td align="right" class="lefttd" height="30" style="width: 198px">
                       <strong>推荐用户注册给推荐人：</strong></td>
                   <td class="righttd">
                       赠送资金 <asp:TextBox CssClass="textbox" ID="TxtTJMoney" Text="0" runat="server" Width="55px" style="text-align:center"></asp:TextBox>元
                       赠送积分：<asp:TextBox CssClass="textbox" ID="TxtTJScore" Text="0" runat="server" Width="55px" style="text-align:center"></asp:TextBox>分
                       赠送点券：<asp:TextBox CssClass="textbox" ID="TxtTJPoint" Text="0" runat="server" Width="55px" style="text-align:center"></asp:TextBox>点
                       <span class="tips">Tips:设置为0时不赠送</span>
                   </td>
               </tr>
               ...
               <tr>
                   <td align="right" class="lefttd"  style="width: 198px;height:30px">
                       <strong>启用点券功能：</strong></td>
                   <td class="righttd">
                      <asp:RadioButtonList ID="RdbIsPoint" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
               ...
               <tr>
                ...
                <tr>
                   <td align="right" class="lefttd"  style="width: 198px;height:30px">
                       <strong>用户名隐藏显示处理：</strong></td>
                   <td class="righttd">
                      <asp:RadioButtonList ID="RdbHidUserName" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                          <asp:ListItem Value="1">是</asp:ListItem>
                          <asp:ListItem Value="0">否</asp:ListItem>
                      </asp:RadioButtonList>
                      <span class="tips">如果选择“是”，则会员在评论等地方发表时显示的用户名将是类似“aa***c"的格式；</span>
                       </td>
               </tr>
  </table>
...
<table width="100%" border="0" cellpadding="1" cellspacing="1" class="CTable"> 
               <tr>
                   <td align="right" class="lefttd" height="30" style="width: 198px">
                       <strong>生成缩略图设置：</strong></td>
                   <td class="righttd">
                       宽度 <asp:TextBox CssClass="textbox" ID="ThumbsWidth" runat="server" Width="54px"></asp:TextBox>像素 &nbsp;<span class="tips">设为0时，将以高度为准按比例缩小。</span>
                     <br /><br />
                       高度 <asp:TextBox CssClass="textbox" ID="ThumbsHeight" runat="server" Width="53px"></asp:TextBox>像素 &nbsp;<span class="tips">设为0时，将以宽度为准按比例缩小。</span>
               ...
               <tbody id="watermarkpicarea" style="display:none" runat="server">
                   ...
                   <td class="righttd"><table cellspacing="0" cellpadding="0"><tr><td><asp:TextBox CssClass="textbox" ID="WaterMarkPic" Width="350" runat="server"></asp:TextBox>&nbsp;<input type="button" class="button" onclick="SelectFiles('<%=this.WaterMarkPic.ClientID %>',0);" value="选择Logo..."></td>
                                                          <%if (Kesion.BLL.KSSecurity.CheckCommonUploadPower()){ %>
                                                                <td style="padding-left:4px;padding-top:12px;"> <%=Kesion.APPCode.UploadAPI.EchoUpload("classpic",this.WaterMarkPic.ClientID,150) %></td>
                                                            <%} %>
                                                                <td><img id="show<%=WaterMarkPic.ClientID %>" src="<%=WaterMarkPic.Text%>"  height="30" style="border:1px solid #f1f1f1;" onerror="this.src='../../sysimg/nopic.gif'"/></td>
                                                              </tr>
                                                    </table>
                 </td>
               </tr>                    
           ...
           <tr>
                   <td align="right" class="lefttd" height="30" style="width: 198px">
                       <strong>缩略图加水印：</strong></td>
                   <td class="righttd">
                       <asp:RadioButtonList ID="RdbThumbAddWaterMark" runat="server" RepeatDirection="Horizontal">
		  ...
		  <h2 class="tab">其它选项</h2>
            ...
            <table width="100%" border="0" cellpadding="1" cellspacing="1" class="CTable"> 
               <tr>
                   ...
                   <td class="righttd">
                       PC模板总目录&nbsp;&nbsp; <asp:TextBox CssClass="textbox" ID="TemplateDir" runat="server" Width="350"></asp:TextBox>
                       <span class="tips">后面不要带"/"。</span><br /><br />
                       手机模板总目录 <asp:TextBox CssClass="textbox" ID="TxtTemplate01" runat="server" Width="350"></asp:TextBox>
                       <span class="tips">后面不要带"/"。</span><br /><br />
                       个人空间模板总目录 <asp:TextBox CssClass="textbox" ID="TxtTemplate03" runat="server" Width="350"></asp:TextBox>
                       <span class="tips">后面不要带"/"。</span><br /><br />
                       <div<%=System.IO.Directory.Exists(Utils.GetMapPath("/admin/course/")) == true?"":" style='display:none'" %>>
                       机构模板总目录 <asp:TextBox CssClass="textbox" ID="TxtTemplate02" runat="server" Width="350"></asp:TextBox>
              ...
              <tr>
                 ...
                 <tr>
                  <td align="right" class="lefttd" height="30" style="width: 198px">
                      <strong>上传文件存放目录格式：</strong></td>
                  <td class="righttd">
                    <asp:RadioButtonList ID="RdbUploadDirType" runat="server" RepeatLayout="Flow">
                        <asp:ListItem Value="0">总上传目录/年-月/管理员ID/</asp:ListItem>
                        <asp:ListItem Value="1">总上传目录/年-月-日/管理员ID/</asp:ListItem>
                        <asp:ListItem Value="2">总上传目录/年-月/</asp:ListItem>
                        <asp:ListItem Value="3">总上传目录/年-月-日/</asp:ListItem>
                        <asp:ListItem Value="4">总上传目录/管理员ID/</asp:ListItem>
                        <asp:ListItem Value="5">总上传目录/年/</asp:ListItem>
                        <asp:ListItem Value="6">总上传目录/年/管理员ID/</asp:ListItem>
                        <asp:ListItem Value="7">总上传目录/管理员ID/年-月/</asp:ListItem>
                        <asp:ListItem Value="8">总上传目录/管理员ID/年-月-日/</asp:ListItem>
                    </asp:RadioButtonList>
                  </td>
              </tr>
            <tr>
             <td class="lefttd" height="30" align="right" style="width: 198px"><b>全站搜索设置：</b></td>
                <td class="righttd">
                    <strong>启用模糊搜索：</strong>
           ...
           <tr>
            ...
            <td class="righttd">
              ...
              <tr>
                  <td align="right" class="lefttd" height="30" style="width: 198px">
                      <strong>生成路径设置：</strong></td>
                  <td class="righttd">
                      <asp:RadioButtonList ID="RdbFsoPath" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                          <asp:ListItem Value="0" Selected="True">绝对路径</asp:ListItem>
                          <asp:ListItem Value="1">根相对路径 (相对根目录)</asp:ListItem>
                      </asp:RadioButtonList>
                     <span class="tips">若您有绑定子站点,此处请设置为绝对路径，否则可能导致链接不正确。</span>
                  </td>
              </tr>
              ...
              <tr>
                  ...
                  <td class="righttd">
                     ...
                     分钟后自动生成智能JS
                      <div class="tips">不想自动生成JS或是没有使用JS标签，请设置为“0”以免影响性能。</div>
                      </div>
                  </td>
              </tr>
  </table>
