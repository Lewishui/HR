...
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
        <div id="manage_top" class="menu_top_fixed">
           <ul>
           	<li id='p6'><a href="?dir=<%=_parentDir %>"><b></b>返回上一层目录</a></li>
   ...
   <div class="content-area">         
        <asp:Panel ID="Panel1"  cssclass="CTable" runat="server" Width="100%">
            ...
            <table border="0" width="99%" align="center">
             <tr>
              <td colspan="2" height="30" class="righttd">当前目录:<asp:Label ID="LabCurrDir" runat="server"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;占用大小:<asp:Label ID="LabSite" runat="server" ForeColor="red"></asp:Label></td>
             </tr>
            </table>
            ...
            <asp:DataList ID="DataList2" runat="server" RepeatColumns="4" Width="99%" CssClass="lefttd" HorizontalAlign="Center" CellPadding="1" CellSpacing="1" >
                ...
                <ItemStyle CssClass="lefttd" BackColor="White" />
            </asp:DataList>
