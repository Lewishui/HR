...
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
 ...
 <!--
     ...
     <br />
     <asp:Panel ID="Panel1" runat="server" Width="100%" CssClass="main-button">
        ...
        <br />
        <script type="text/javascript">
            showtips('<span class="state"><strong>说明：</strong><br /></span>1、如果您对伪静态规则不了解，上面的配置建议不要做修改；<br/>2、扩展名为非.aspx时， 需要服务器IIS里配置，右键打开属性对话框→【主目录】标签→【配置】→【添加】可执行文件路径:%windir%\\Microsoft.NET\\Framework\\v4.0.30319\\aspnet_isapi.dll 扩展名如.html，【确认文件是否存在】的勾请去掉；<br/>2、扩展名为“/”时（即无扩展名），IIS6设置方法同上，扩展名设置为“.*” 。IIS7的设置方法为，处理程序映射，添加通配符脚本脚本映射，可执行文件为“%windir%\\Microsoft.NET\\Framework\\v4.0.30319\\aspnet_isapi.dll”。');
		</script>
