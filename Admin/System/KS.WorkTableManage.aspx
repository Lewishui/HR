   ...
   <asp:Panel ID="ListPanel" runat="server" Width="100%">
    <script>
        function addWorkTable() {
            parent.openWin("添加快捷键到我的工作台", "<%=KSCMS.GetInstallDir()+MyCache.GetCacheConfig(4)%>/System/KS.WorkTableManage.aspx?action=add", true, 720, 460);
        }
        function editWorkTable(id) {
            parent.openWin("修改我的工作台的快捷键", "<%=KSCMS.GetInstallDir()+MyCache.GetCacheConfig(4)%>/System/KS.WorkTableManage.aspx?action=modify&id=" + id, true, 720, 460);
        } 
    </script>
       <div id="manage_top" class="menu_top_fixed">
        ...
        <asp:Repeater ID="Repeater1" runat="server"  >
         ...
         <ItemTemplate>
            ...
            <td class="Ctd" style="text-align:center"><img src="<%# Eval("ico") %>" height="36" style="vertical-align:middle" /></td>
         ...
         <KS:Page ID="Page1" runat="server" />
                ...
                <script type="text/javascript">
                    showtips('<span class="state"><strong>操作说明：</strong><br /></span>1、在此页面您可以增加，修改或是删除快捷键到后台首页的我的工作台。<br/>2、链接地址里用标签{$AdminDir}代替后台管理目录名称');
		        </script>
...
<tr>
            ...
            {
                if (KSSecurity.CheckMenuPower(topnode.SelectSingleNode("@role").InnerText)) //检查权限
                {
                    bool isShow = true;
        ...
        <tr>
            ...
            <td id="Td4" runat="server" class="righttd" style="height: 30px; text-align: left; vertical-align:middle">
               <asp:TextBox  CssClass="textbox" ID="TxtIco" runat="server" Width="126px"></asp:TextBox>
                 ...
                 <img src="../../sysimg/default/1.png" height="36" id="img" style="vertical-align:middle" />
                 <br />
     ...
     <asp:Button ID="Button1" CssClass="button" runat="server" OnClientClick="return(checkform())" Text="确定创建(O)" AccessKey="O" OnClick="Button1_Click"/>
           <input type="button" class="button" onclick="javascript: parent.isreload = false;parent.box.close();" accesskey="C" value="关闭取消(C)" /><br />
     </div>
