    ...
    <div class="content-area">   
        ...
        <Columns>
            ...
            <ItemTemplate>
              ...
              <asp:TextBox CssClass="textbox" ID="TxtCity" Text='<%#Eval("City") %>' runat="server" Width="280px"></asp:TextBox>
            ...
            <asp:TemplateField HeaderText="切换地区显示">
            <ItemStyle HorizontalAlign="Center"  />
            <ItemTemplate>
                <asp:HiddenField ID="HidIsShow" runat="server" Value='<%# Eval("IsShow") %>' />
                 <asp:RadioButtonList ID="RdbIsShow" runat="server" RepeatLayout="Flow" RepeatDirection="Horizontal">
...
<div class="content-area">
        ...
        <tr>
          ...
          <tr>
            ...
            <tr>
                <td align="right" class="lefttd" height="30" style="width: 198px">
                    <strong>是否显示地区切换：</strong></td>
                <td class="righttd">
                    &nbsp;<asp:RadioButtonList ID="RdbIsShow" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
