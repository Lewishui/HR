...
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
 ...
 <span style="float:right; padding-right:20px;"><%=templateName %></span>
<ul>
      ...
      <li id='p9'><a href="?Action=sublist&currpath=<%=_PreFolder %>"><b></b>回上一级</a></li>
      <li id='p15'><a href="KS.Label.Param.aspx"><b></b>标签参数说明</a></li>
</ul>
 </div>
 <div class="menu_top_fixed_height"></div>  
<div class="content-area"> 
<div class="myTitle">模板文件管理</div>
<script>
    function uptemplate()
   {  
        parent.openWin("上传模板文件", "<%=KSCMS.GetInstallDir()+MyCache.GetCacheConfig(4)%>/Label/KS.TemplateUp.aspx?currpath=<%=_CurrPath %>", true, 620, 260);
    } 
    function addtemplate()
   {  
        parent.openWin("创建模板文件", "<%=KSCMS.GetInstallDir()+MyCache.GetCacheConfig(4)%>/Label/KS.TemplateAdd.aspx?currpath=<%=_CurrPath %>", true, 620, 220);
    }
    function clonetemplate(file) {
        parent.openWin("克隆模板文件", "<%=KSCMS.GetInstallDir()+MyCache.GetCacheConfig(4)%>/Label/KS.TemplateClone.aspx?currpath=<%=_CurrPath %>&file=" + file, true, 620, 220);
    }
    ...
    <table style="display:none" width="100%" border="0" cellpadding="1" cellspacing="1" class="CTable">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="重命名">
                     ...
                     <asp:TemplateField HeaderText="克隆">
                        ...
                        <itemtemplate>
                         <%# Eval("TypeName") == "目录" ? "---" : @"<a href='javascript:;' onclick=""clonetemplate('"+ Eval("Name")+@"')""  title=""克隆模板"" class=""copy"">" %></a>
                      </itemtemplate>
                    </asp:TemplateField>
                </Columns>
        ...
        <table width="100%" border="0" cellpadding="1" cellspacing="1" class="CTable">
           ...
           <tr class="ctr">
            ...
            <div class="labels">
             <ul>
               <li><a href="#" onclick="insertlabel('插入网站公用标签','Label/KS.LabelCommon.aspx',850,500,'auto');return false;">公用标签</a></li>
               <li><a href="#" onclick="insertlabel('入门级标签','Label/KS.LabelFun.aspx?LabelType=1',850,500,'auto');return false;">入门级标签</a></li>
               <li><a href="#" onclick="insertlabel('中级标签','Label/KS.LabelFun.aspx?LabelType=2',850,500,'auto');return false;">中级标签</a></li>
               <li><a href="#" onclick="insertlabel('中级标签','Label/KS.LabelFun.aspx?LabelType=3',850,500,'auto');return false;">高级标签</a></li>
               <li><a href="#" onclick="insertlabel('插入内容页标签','Label/KS.LabelContent.aspx',850,500,'auto');return false;">内容页标签</a></li>
               <li><a href="#" onclick="insertlabel('插入专题系统标签','Label/KS.LabelSpecial.aspx',850,500,'auto');return false;">专题系统标签</a></li>
             </ul>
            </div>
