...
<body scroll="auto">
    <form id="form1" runat="server">
      ...
      <tr>
       <td>
          <table width="96%" align="center" cellpadding="0" cellspacing="0">
           ...
           <tr>
             <td><span class="label_4"></span><a href="#" onclick="getlabel('内容页时间标签','ks_adddate.html',300,160,'auto');return false;">带格式时间</a></td>
             <td><span class="label_4"></span><a href="#" onclick="parent.frames['main'].InsertLabel('{KS:Field:GetVote}')">显示投票</a></td>
             <td><span class="label_4"></span><a href="#" onclick="parent.frames['main'].InsertLabel('{KS:Field:ItemUrl}')">显示文档URL</a></td>
             <td><span class="label_4"></span><a href="#" onclick="parent.frames['main'].InsertLabel('{KS:Field:InputerUserID}')">录入者UserID</a></td>
             <td><span class="label_4"></span><a href="#" onclick="parent.frames['main'].InsertLabel('{KS:Field:InputerRealName}')">录入者姓名</a></td>
           </tr>
          </table>
     ...
     <div class="pop-button">
     	<input type="button" class="button" onclick="javascript:parent.box.close();" accesskey="C" value="关闭取消(C)" />
     </div>
