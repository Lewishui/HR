        ...
        <asp:Panel ID="Step2Panel" runat="server" Visible="false" Width="100%">
            ...
            <tr>
                ...
                <td id="Td3" runat="server" class="righttd" colspan="2" style="height: 30px; text-align: left">
                   ...
                   <asp:ListItem Value="i.goodnum asc">点赞数升序</asp:ListItem>
                    <asp:ListItem Value="i.goodnum desc">点赞数降序</asp:ListItem>
                    <asp:ListItem Value="i.favnum asc">收藏数升序</asp:ListItem>
                    <asp:ListItem Value="i.favnum desc">收藏数降序</asp:ListItem>
                    <asp:ListItem Value="i.sharenum asc">分享数升序</asp:ListItem>
                    <asp:ListItem Value="i.sharenum desc">分享数降序</asp:ListItem>
            ...
            <tr>
                ...
                <td id="Td4" runat="server" class="righttd" colspan="2" style="height: 30px; text-align: left">
                 <table border="0" cellpadding="0" cellspacing="0">
                     <tr>
                      <td style="width: 1px">
                      <select name='classid1' id='classid1' multiple size='3' style='width: 120px; height:120px'>
...
<td nowrap style="padding-left:10px;"><strong> 所属品牌：</strong>
                     
                      
                      </td>
                      <td valign="top">
                          <asp:ListBox ID="LstBrandID" runat="server" SelectionMode="Multiple" Width="120" Height="120" Rows="3">
