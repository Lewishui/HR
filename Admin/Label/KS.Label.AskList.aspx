...
<tr>
                 ...
                 <tr>
                  <td valign="top" width="280">
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                       <td><asp:ListBox ID="LstClassID" runat="server" SelectionMode="Multiple" Height="120">
                <asp:ListItem Value="0" Selected>--问答分类不限--</asp:ListItem>
                </asp:ListBox><br/>
                     <a class="textarea_min" href="javascript:zoomtextarea(-5,'<%=LstClassID.ClientID %>');"></a>
                      <a class="textarea_max" href="javascript:zoomtextarea(5,'<%=LstClassID.ClientID %>');"></a></td>
        ...
        <tr>
                ...
                <td id="Td3" runat="server" class="righttd" colspan="2" style="height: 30px; text-align: left">
                    <asp:TextBox style="text-align:center" CssClass="textbox" ID="Num" runat="server" Width="60px">10</asp:TextBox>条&nbsp;
            ...
            <tr>
               ...
               <tr>
                <td align="center"><div onclick="InsertValue('{KS:Field:DefaultPic}')" class="field" style="cursor:pointer">首页图片</div></td>
                <td align="center"><div onclick="InsertValue('{KS:Field:Content}')" class="field" style="cursor:pointer">问题补充</div></td>
                <td align="center"><div onclick="InsertValue('{$Field(SolveTime,date,YY-MM-DD)}')" class="field" style="cursor:pointer">解决时间</div></td>
                <td align="center"><div onclick="InsertValue('{KS:Field:IsSolve}')" class="field" style="cursor:pointer">是否解决</div></td>
