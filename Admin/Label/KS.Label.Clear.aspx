...
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
    ...
    <div id="manage_top" class="toptitle menu_top_fixed"><span style="float:right;font-weight:normal;"><%=templateName %></span>以下标签没有被模板调用可以删除</div>
    <div class="menu_top_fixed_height"></div> 
<div class="content-area">

    <KS:KSGV ID="List" cssclass="CTable" runat='server' AllowPaging="true" PageSize="20" PagerType="CustomNumeric" Width="99%" HorizontalAlign="center" EmptyDataText="没有找到不可用的标签记录！" AutoGenerateColumns="False" GridLines="None" 
        OnRowDataBound="List_RowDataBound" OnRowCommand="List_RowCommand" OnRowCreated="List_RowCreated" onpageindexchanging="List_PageIndexChanging" CellSpacing="1">
                <Columns>
           ...
           <table cellpadding="0" cellspacing="0" style="width: 100%;margin-top:10px">
            ...
            <input type="button" value="删除选中的标签" onmouseover="this.className='button_on';" onmouseout="this.className='button';" class="button" onclick="if (GetIDS('del')) { this.form.action = '?action=del'; this.form.submit() }" />
                    ...
                    <asp:Button ID="BtnDelAll" Text="一键清空所有无用标签" OnClientClick="return(confirm('此操作不可逆，确认清空无用标签吗？'));" CssClass="button" runat="server" OnClick="BtnDelAll_Click" />
                    <input type="button" value="返回标签管理" class="button" onclick="location.href ='KS.Label.aspx?LabelType=2&templateId=<%=templateId%>';" />
                      </td>
