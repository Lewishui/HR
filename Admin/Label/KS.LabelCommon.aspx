...
<body scroll="auto">
       ...
       <td>
          <table width="96%" align="center" cellpadding="0" cellspacing="0">
           ...
           <tr>
            ...
            <td><span class="label_4"></span><a href="#" onclick="parent.frames['main'].InsertLabel('{$GetWeiXinLogin}')">会员登录(微信扫码)</a></td>
           </tr>
           <tr>
            ...
            <tr>
            <td><span class="label_4"></span><a href="#" onclick="parent.frames['main'].InsertLabel('{#GetFullDomain}')">网址域名（完整不过滤）</a></td>
  ...
  <%if (MyCache.GetCacheConfig(72).Equals("1")){ %>
       <tr>      
       <td style="height:30px;border-bottom:1px solid #cccccc;padding-left:10px;"><span class="folder"></span><strong>手机专用标签</strong></td>
       </tr>
       <tr>
       <td>
        <table width="96%" align="center" cellpadding="0" cellspacing="0">
           <tr>
            <td><span class="label_4"></span><a href="#" onclick="parent.frames['main'].InsertLabel('{M:G3InstallDir}')">手机版安装目录</a></td>
            <td><span class="label_4"></span><a href="#" onclick="parent.frames['main'].InsertLabel('{M:G3SiteName}')">手机版站点名称</a></td>
            <td><span class="label_4"></span><a href="#" onclick="parent.frames['main'].InsertLabel('{M:G3Logo}')">手机版站点Logo</a></td>
            <td><span class="label_4"></span><a href="#" onclick="parent.frames['main'].InsertLabel('{M:G3CopyRight}')">手机版底部版权</a></td>
            <td><span class="label_4"></span><a href="#" onclick="parent.frames['main'].InsertLabel('{M:TemplateDir}')">模板目录</a></td>
           </tr>
           <tr>
             <td><span class="label_4"></span><a href="#" onclick="parent.frames['main'].InsertLabel('{M:CompanyName}')">公司名称</a></td>
            <td><span class="label_4"></span><a href="#" onclick="parent.frames['main'].InsertLabel('{M:CompanyAddress}')">公司地址</a></td>
            <td><span class="label_4"></span><a href="#" onclick="parent.frames['main'].InsertLabel('{M:ComapnyPhone}')">固定电话</a></td>
            <td><span class="label_4"></span><a href="#" onclick="parent.frames['main'].InsertLabel('{M:CompanyTelphone}')">移动电话</a></td>
            <td><span class="label_4"></span><a href="#" onclick="parent.frames['main'].InsertLabel('{M:CompanyFax}')">传真</a></td>
           </tr>
             <tr>
             <td><span class="label_4"></span><a href="#" onclick="parent.frames['main'].InsertLabel('{M:ComapnyEmail}')">E-Mail</a></td>
            <td><span class="label_4"></span><a href="#" onclick="parent.frames['main'].InsertLabel('{M:PostCode}')">邮编</a></td>
            <td><span class="label_4"></span><a href="#" onclick="parent.frames['main'].InsertLabel('{M:QQ}')">QQ</a></td>
            <td><span class="label_4"></span><a href="#" onclick="parent.frames['main'].InsertLabel('{M:Contact}')">联系人</a></td>
            <td><span class="label_4"></span><a href="#" onclick="parent.frames['main'].InsertLabel('{M:Decription}')">描述</a></td>
           </tr>
            <tr>
             <td><span class="label_4"></span><a href="#" onclick="parent.frames['main'].InsertLabel('{M:KeyWords}')">关键词</a></td>
            <td><span class="label_4"></span><a href="#" onclick="parent.frames['main'].InsertLabel('{M:CompanyIntro}')">公司简介</a></td>
            <td><span class="label_4"></span><a href="#" onclick="parent.frames['main'].InsertLabel('{M:CompanyContent}')">公司具体内容</a></td>
            <td><span class="label_4"></span><a href="#" onclick="parent.frames['main'].InsertLabel('{M:BaiduKey}')">百度密匙</a></td>
            <td><span class="label_4"></span><a href="#" onclick="parent.frames['main'].InsertLabel('{M:BaiduPoint}')">百度坐标</a></td>
           </tr>
           </table>
       </td>
       </tr>
 <%} %>
      ...
      <td>
         ...
         <div class="pop-button">
         	<input type="button" class="button" accesskey="C" onclick="javascript:parent.box.close();" value="关闭取消(C)" />
         </div>
