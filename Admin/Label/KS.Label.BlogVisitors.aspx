     ...
     <td class="righttd" style="text-align: left; height: 30px;"><span  id="classidarea" runat="server"></span><font color=red> 请选择标签所属目录，以便日后管理标签</font></td>
        ...
        <tr>
            ...
            <tr>
                ...
                <td align="center"><div onclick=InsertValue('{KS:Field:Visitor}'); title="访客照片" class="field" style="cursor:pointer">访客用户名</div></td>
                <td align="center"><div onclick="InsertValue('<img src=\'/UploadFiles/avatar/{KS:Field:VisitorID}.jpg\'/>');" title="访客照片" class="field" style="cursor:pointer">访客照片</div></td>
                </tr>
