...
<body  class="righttd" scroll="auto">
   <script type="text/JavaScript">
        function addFile()
        {
        var str = '<div>文件:<INPUT type="file" class="textbox" size="50" NAME="File"></div>'
    ...
    <table width="100%" border="0" cellpadding="1" cellspacing="1">
           ...
           <td class="righttd">
                <div id="MyFile">文件:<input size="50" class="textbox" type="file" name="File" /></div>
        ...
        <tr>
           ...
           <input type="button" class="button" onclick="parent.isreload = false;parent.box.close();" accesskey="C" value="关闭取消(C)" /><br />
              <br />
