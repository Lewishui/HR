<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Inherits="Kesion.NET.WebSite.Admin_Label_PageStyle" Title="分页样式管理" Codefile="KS.Label.PageStyle.aspx.cs" %>
...
<asp:Panel ID="ListPannel" runat="server" Width="100%">
 <div id="manage_top" class="toptitle menu_top_fixed" style="text-align:left">
     <ul>
     	<li id="p1"><a href="?action=Add"><b></b>添加新样式</a></li>
     </ul>   
     <span style="float:right"><%=templateName %></span>
 </div>
  <div class="menu_top_fixed_height"></div>   
  <div class="content-area">
  	<div class="myTitle">分页样式管理</div>
        ...
        <Columns>
           <asp:TemplateField HeaderText="ID" InsertVisible="False">   
            ...
            <ItemStyle HorizontalAlign="Center" />
            <ItemTemplate>
              <asp:TextBox CssClass="textbox" TextMode="MultiLine" ID="TxtTp" Width="470" Height="130" Text='<%#Eval("tp") %>' runat="server"></asp:TextBox>
             </ItemTemplate> 
            </asp:TemplateField>
