...
<KS:TopNav runat="server" Text="品牌列表标签第一步" ID="TopNav1" />
 ...
 <tr>
                ...
                <td class="righttd" style="height: 30px; text-align: left">
                    <asp:TextBox ID="TxtCacheTime" CssClass="textbox" Text="-1" runat="server" Width="60px" style="text-align:center"></asp:TextBox>分钟
    ...
    <KS:Foot ID="Foot1" runat="server" OnSubmit="Foot1_Submit" SubmitButtonText="下一步(0)" />
        ...
        <asp:Panel ID="Step2Panel" runat="server" Visible="false" Width="100%">
            ...
            <tr>
                ...
                <td id="Td4" runat="server" class="righttd" colspan="2" style="height: 30px; text-align: left">
                 <table border="0" cellpadding="0" cellspacing="0">
                     ...
                     <%=MyCache.GetShopClassOptionList(0)%>
                      </select>
                       <br/>
                     <a class="textarea_min" href="javascript:zoomtextarea(-5,'classid1');"></a>
                      ...
                      <asp:CheckBox ID="ChildClass" runat="server" Checked="true" Text="允许列出子栏目品牌(仅对单选有效)" />
            ...
            <tr>
                ...
                <td align="center"><div onmousedown="DragStart()" id="PhotoUrl" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">品牌小图</div></td>
                <td align="center"><div onmousedown="DragStart()" id="BigPhoto" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">品牌大图</div></td>
                ...
                <tr>
                  ...
                  <td align="center"><div onmousedown="DragStart()" id="Num" fieldtype="0" onclick="InsertLabel(this.id,this.fieldtype)" class="field" style="cursor:pointer">商品数量</div></td>
