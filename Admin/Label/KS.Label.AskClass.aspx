            ...
            <tr>
                ...
                <td runat="server" class="righttd" colspan="2" style="height: 30px; text-align: left">
                 <table border="0" cellpadding="0" cellspacing="0">
                     <tr>
                      <td>
                      <asp:ListBox ID="DrpClassID" runat="server" Rows="4" SelectionMode="Multiple" Height="120" Width="300">
                       <asp:ListItem Value="0">顶级分类导航</asp:ListItem>
                      </asp:ListBox>
                      <br/>
                     <a class="textarea_min" href="javascript:zoomtextarea(-5,'<%=DrpClassID.ClientID %>');"></a>
                      <a class="textarea_max" href="javascript:zoomtextarea(5,'<%=DrpClassID.ClientID %>');"></a>
                     </td>
                      <td>
