...
<body leftMargin=0 class="righttd" scroll="no" style="overflow:hidden; background:#fff">
      ...
      <td colSpan=2 height=35>
        <table height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0>
          <tr>
            ...
            <%if (Kesion.BLL.KSSecurity.CheckCommonUploadPower() || ChannelID>0){ %>
          <tr>
...
if (v=='') KesionJS.Alert('请填写Url地址');    
else   
 {
    ...
    <%}%>
    try {
        <%if (!string.IsNullOrEmpty(KSCMS.S("fun"))){%>
        top.frames["main"].<%=KSCMS.S("fun")%>;
        <%}%>
