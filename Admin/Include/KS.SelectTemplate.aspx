...
<body topmargin="0" leftmargin="0" class="righttd" <%=string.IsNullOrEmpty(KSCMS.S("action"))?@" scroll=""no""":string.Empty %>>
    ...
    <tr>
    <td>
      <iframe runat="server" id="FolderList" width='100%' height='400' frameborder='1' src='about:blank;' scrolling="yes"></iframe>
    </td>
    </tr>
    <tr class="ctitle">
    <td height="35" align="center">
    <div class="pop-button" style="padding:0"> 
    ...
    <tr>
      <td clospan=2 style="text-align:center" class="tips">Tips:双击返回选中的模板。</td>
    </tr>
    </table>
    </form>
    <script language='JavaScript'>
        $(document).ready(function () {
            $("#FolderList").attr("src", "KS.SelectTemplate.aspx?Action=filelist&from3g=<%=KSCMS.S("from3g") %>");
        });
    function winClose() {
            try {
                top.box.close();
    ...
    {    
        frames["FolderList"].location = 'KS.SelectTemplate.aspx?Action=filelist&from3g=<%=KSCMS.S("from3g") %>&CurrPath=' + CurrPath;
    }
    ...
    <asp:panel ID="listpannel" runat="server">
        ...
        function OpenFolder(Path)
        {
            ...
            location.href = 'KS.SelectTemplate.aspx?Action=filelist&from3g=<%=KSCMS.S("from3g") %>&CurrPath=' + escape(SubmitPath);
