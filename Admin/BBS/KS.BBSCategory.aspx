             ...
             <table width="100%" border="0" cellpadding="1" cellspacing="1" class="CTable">
               ...
               <tr>
                ...
                <tr>
                    ...
                    <td class="righttd">
                        每页加载<asp:TextBox Text="5" CssClass="textbox" ID="TxtRollTopicPageNum" runat="server" style="text-align:center" Width="50px"></asp:TextBox>条话题
                        话题详细页每页加载<asp:TextBox Text="5" CssClass="textbox" ID="TxtRollReplyPageNum" runat="server" style="text-align:center" Width="50px"></asp:TextBox>条回复
                        </td>
                 </tr>
                <tr>
                    <td  height="30" class="lefttd" align="right" style="width: 155px">
                    ...
                    <td class="righttd">
                        浏览数大于<asp:TextBox Text="100" CssClass="textbox" ID="TxtHotTopicHits" runat="server" style="text-align:center" Width="50px"></asp:TextBox>次且回复数大于<asp:TextBox Text="10" CssClass="textbox" ID="TxtHotReplyHits" runat="server" style="text-align:center" Width="50px"></asp:TextBox>楼时自动转为热帖
                        </td>
                 </tr>
