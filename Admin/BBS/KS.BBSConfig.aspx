   ...
   <div class="content-area"> 
    ...
    <table id="tbs" width="100%" border="0" cellpadding="1" cellspacing="1" class="CTable"> 
        ...
        <tr>
         ...
         <tr>
            <td align="right" class="lefttd" height="30" style="width: 198px">
                <strong>上传图片自动压缩：</strong></td>
            <td class="righttd">
                 
                宽<asp:TextBox ID="TxtDefaultPicWidth" style="text-align:center" CssClass="textbox" runat="server" Text="500" Width="50"></asp:TextBox>像素
                高<asp:TextBox ID="TxtDefaultPicHeight" style="text-align:center" CssClass="textbox" runat="server" Text="0" Width="50"></asp:TextBox>像素
                <span class="tips">(宽和高设置为“0”不启用自动压缩，启用自动压缩图片建议高度设置成“0”，将自动根据宽度自适应。)</span>
           </td>
        </tr>
