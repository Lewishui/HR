...
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
 ...
 <div class="content-area">   
    <script>
     ...
     <div class="myTitle">
      话题回复管理<!--<asp:Label ID="LabNav" runat="server"></asp:Label>-->
<div class="quickSearch">搜索回答：<asp:TextBox runat="server" ID="TxtKeyWord" CssClass="textbox" /> 
</asp:DropDownList>
        ...
        <Columns>
         <asp:TemplateField HeaderText="选择">
            ...
            <asp:BoundField HeaderText="回答时间" DataField="adddate">
                ...
                <itemstyle horizontalalign="Center" />
             <itemtemplate>
             <asp:LinkButton runat="server"  CssClass="edit" title="编辑" commandargument=<%#Eval("postid") %> commandname="modify">修改</asp:LinkButton>
             <asp:LinkButton runat="server"  CssClass="delete" title="删除" id="delete" commandargument=<%#Eval("postid") %> commandname="del">删除</asp:LinkButton></itemtemplate></asp:TemplateField></Columns><HeaderStyle CssClass="CTitle" />
