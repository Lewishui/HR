<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Inherits="Kesion.NET.WebSite.Admin_AskCategoryOrderN" Title="N级分类排序" Codebehind="KS.AskCategoryOrderN.aspx.cs" %>
...
<div class="content-area">
    ...
    <KS:KSGV ID="List" runat="server" AutoGenerateColumns="False" CssClass="CTable" EmptyDataText="没有添加任何分类!" GridLines="None" OnRowDataBound="List_RowDataBound" PagerType="CustomNumeric" Width="99%" OnRowCommand="List_RowCommand">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="分类名称">
                <itemtemplate>
        <%# getClassListName(Eval("Classname", "{0}"), Convert.ToInt16(Eval("child")), Convert.ToInt16(Eval("NextID")), Convert.ToInt16(Eval("depth", "{0}")),1)%>
            </itemtemplate>
            </asp:TemplateField>
            <asp:BoundField DataField="OrderID" HeaderText="序号" />
            <asp:TemplateField HeaderText="N级分类排序">
                <itemtemplate>
