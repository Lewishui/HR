<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Inherits="Kesion.NET.WebSite.Admin_Ask_Rank" Title="问吧等级管理" Codebehind="KS.AskRank.aspx.cs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">

<asp:Panel ID="ListPannel" runat="server" Width="100%">
 <div id="manage_top" class="menu_top_fixed"> 
   <ul>
         <li id="p1"><a href="?action=Add"><b></b>添加新等级</a></li>
   </ul>
  </div>
 
 <div class="menu_top_fixed_height"></div> 
 <div class="content-area">
 	<div class="myTitle">问吧等级管理</div>
        <asp:GridView ID="RankList" cssclass="CTable"  runat="server" AutoGenerateColumns="False" EmptyDataText="还没有添加问吧等级!"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="问题数">
            <ItemStyle HorizontalAlign="Center" />
            <ItemTemplate>
        ...
        <table width="99%" style="margin:0 auto;" border="0" cellpadding="1" cellspacing="1" class="CTable"> 
          ...
          <tr>
            ...
            <td class="righttd">
                ...
                &nbsp;问题数：<asp:TextBox CssClass="textbox" Width="50px" style="text-align:center" ID="TxtQueNum" Text="0" runat="server"></asp:TextBox> 
                &nbsp;回答数：<asp:TextBox CssClass="textbox" Width="50px" style="text-align:center" ID="TxtAnsNum" Text="0" runat="server"></asp:TextBox> 
              </td>
          </tr>
