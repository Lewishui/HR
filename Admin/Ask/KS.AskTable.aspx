<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Inherits="Kesion.NET.WebSite.Admin_Ask_Table" Title="问吧数据表管理" Codebehind="KS.AskTable.aspx.cs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">

<asp:Panel ID="ListPannel" runat="server" Width="100%">
<div id="manage_top" class="menu_top_fixed">
  	<ul>
		<li id="p1"><a href="?action=Add"><b></b>添加新数据表</a></li>
    </ul>    
</div>
<div class="menu_top_fixed_height"></div> 
<div class="content-area">
<div class="myTitle">问吧数据表管理</div>
<script type="text/javascript">
    function setRadio(nowRadio) {
        ...
        <asp:GridView ID="RankList"  cssclass="CTable" runat="server" AutoGenerateColumns="False" EmptyDataText="还没有添加问吧数据表!"
    ...
    <KS:Foot ID="Foot1" runat="server" OnSubmit="Foot1_Submit" CancelButtonVisible="false" SubmitButtonText="批量保存(0)" />
     <script type="text/javascript">
         showtips('<span class="state"><strong>说明：</strong><br /></span>1、数据表中选中的为当前问吧所使用来保存回复数据的表，一般情况下每个表中的数据越少问题的详情页显示速度越快，当您上列单个数据表中的数据有超过几万的记录时不妨新添一个数据表来保存回答数据,您会发现问吧速度快很多很多;<br/>2、以免出错，当前正在使用的数据表、已有记录的数据表或是系统自带数据表不允许删除。');
	 </script>
        ...
        <table width="99%" style="margin:0 auto;" border="0" cellpadding="1" cellspacing="1" class="CTable"> 
          ...
          <tr>
            ...
            <td class="righttd">
                ...
                <span class="tips">提示：自定义表系统会自动加上KS_Ask开头。</span>
              </td>
          </tr>
          <tr>
