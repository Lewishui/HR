      ...
      <div id="manage_top" class="toptitle menu_top_fixed">
            ...
            <asp:DropDownList ID="DrpClassID1" runat="server" onchange="location.href='?classid='+this.value;">
             <asp:ListItem Value="0">--按分类查看--</asp:ListItem>
      		...
      		<div class="quickSearch">搜索问题：<asp:TextBox runat="server" ID="TxtKeyWord" CssClass="textbox" /> 
 ...
 <div class="tabs_header">
        ...
        <Columns>
         <asp:TemplateField HeaderText="选择">
            ...
            <asp:TemplateField HeaderText="问题">
                ...
                <%# Convert.ToInt16(Eval("reward"))>0?"<img src='../../"+MyCache.GetAskCacheConfig(1)+"/images/money.gif' align='absmiddle'/><span style='color:red'>"+ Eval("reward")+"</span>分":string.Empty%></itemtemplate></asp:TemplateField>
    ...
    <div class="tab-page" id="sjPanel">
         ...
         <tr>
            ...
            <tr>
            <td align="right" class="lefttd" height="30" style="width: 102px">
                <strong>首页图片：</strong></td><td class="righttd">
                    
                     <table cellspacing="0" cellpadding="0">
                         <tr><td> <asp:TextBox ID="TxtDefaultPic" runat="server" Width="350" CssClass="textbox"></asp:TextBox>
                             &nbsp;<input type="button" class="button" onclick="SelectFiles('<%=this.TxtDefaultPic.ClientID %>',0);" value="选择图片"></td>
                            <td style="padding-left:4px;padding-top:12px;"> <%=Kesion.APPCode.UploadAPI.EchoUpload("classpic",this.TxtDefaultPic.ClientID) %></td>
                               </tr></table>
            ...
            <td align="right" class="lefttd" height="30" style="width: 102px">
             ...
             <asp:RadioButtonList ID="RdbVerify" runat="server" Width="180px" 
                    RepeatDirection="Horizontal" Height="24px">
              <asp:ListItem Value="1" Selected="True">已审核</asp:ListItem><asp:ListItem Value="0">未审核</asp:ListItem></asp:RadioButtonList></td></tr>
             <tr>
            <td align="right" class="lefttd" height="30" style="width: 102px">
