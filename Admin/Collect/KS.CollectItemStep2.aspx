        ...
        <tr>
            <td align="right" class="lefttd" height="30" style="width: 276px">
               ...
               <tr>
                ...
                <tr>
                <td class="lefttd"  style="text-align:left">
                  <strong>分页设置：</strong>
                    <asp:RadioButtonList ID="ListPageType" runat="server" RepeatDirection="Horizontal"  OnSelectedIndexChanged="ListPageType_SelectedIndexChanged" AutoPostBack="True">
                ...
                <td align="center">
                  ...
                  <td class="righttd" valign="top">
                    <strong>采集目标URL：</strong><asp:Label ID="laburl" runat=server></asp:Label>
                      ...
                      <br />
                    <asp:TextBox ID="CodeText" runat="server" TextMode="multiLine" Width="900px" Height="400px"></asp:TextBox>
