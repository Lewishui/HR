...
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
  <KS:TopNav ID="TopNav2" runat="server" Text="采集工作正在初始化" />
    ...
    <div style="text-align:center"><br />
		...
		showtips('<p align="center"><span>本采集系统由厦门科汛软件有限公司独立开发,系统正在初始化,请稍候...<img src="../../admin/images/loading.gif"><br/><br /></span><strong><font color=red>使用声明:采集信息如果涉及到版权问题与厦门科汛软件有限公司无关!</font></strong><br /><br />');
		</script>
