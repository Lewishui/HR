...
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
    ...
    <div id="manage_top" class="menu_top_fixed toptitle">
...
<input type="checkbox"  name="ids" id="ids" value="<%#Eval("HistoryID") %>" />
            ...
            <asp:TemplateField HeaderText="采集">
                <itemstyle width="30px" horizontalalign="Center" />
             <itemtemplate>
             <asp:LinkButton runat="server" id="collect" CssClass="create" commandargument=<%#Eval("itemid") %> commandname="collect"></asp:LinkButton>
