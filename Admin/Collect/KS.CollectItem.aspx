...
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
    ...
    <div id="manage_top" class="menu_top_fixed">
       ...
       <ul>
           ...
           <li id='p5'><asp:LinkButton ID="topverifybutton" runat="server" OnClick="topverifybutton_Click"><b></b>开始采集</asp:LinkButton></li>
           </ul>
    </div> 
...
<input type="checkbox"  name="ids" id="ids" value="<%#Eval("ItemID") %>" />
            ...
            <asp:TemplateField HeaderText="目标站点名称">
              <itemstyle />
              <itemtemplate>
              <span class="gray"><%# Eval("SiteName")%></span>
              </itemtemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="↓管理操作">
             ...
             <itemtemplate>
             <asp:LinkButton runat="server" id="test" commandargument=<%#Eval("itemid") %> commandname="test" CssClass="link-color">测试</asp:LinkButton>
             <asp:LinkButton runat="server" id="collect" commandargument=<%#Eval("itemid") %> commandname="collect" CssClass="link-color">采集</asp:LinkButton>
             <asp:LinkButton runat="server" id="copy" commandargument=<%#Eval("itemid") %> commandname="copy" CssClass="link-color">复制</asp:LinkButton>
   ...
   <!--
    ...
    <table width="99%" align="center" border="0" cellpadding="1" cellspacing="1" class="CTable"> 
        ...
        <tr>
         ...
         <tr>
	       <td align="right" class="lefttd" style="height:30px;width: 198px">
                <strong>文档归属专题：</strong></td>
            <td class="righttd">
                  <table>
                      <tr><td>
                    <select name='SpecialID' id="SpecialID" multiple="multiple" style="height:100px;width:300px;"><%=specialOptionStr %></select>
                     </td><td> 
	                    <input class='button'  type='button' name='Submit' value='选择专题...' onclick='SelectSpecial();' />
                         <div style='text-align:center'><span style="color:Red">X</span> <a href='javascript:UnSelectAll()'><font color='#999999'>取消选定的专题</font></a></div>
                     </td>
                      </tr>
                  </table>
        ...
        <tr>
            ...
            <td class="righttd">
                &nbsp;<asp:TextBox CssClass="textbox" Text="0" ID="CollectInfoNum"  Width="40px" runat="server"></asp:TextBox> <font color=green>“0”或空表示采集所有文档，否则表示成功采集这里设定的记录后将停止。</font></td>
        </tr>
        <tr>
            <td align="right" class="lefttd" style="height:30px;width: 198px">
            <b>项目介绍：</b>
