 ...
 <div class="content-area">   
     <table width="100%" border="0" cellpadding="1" cellspacing="1" class="CTable"> 
          <tr>
            ...
            <td class="righttd">
                <input type="radio" name="optype" onclick="jQuery('#grouparea').hide();" value="1"<%if (string.IsNullOrEmpty(KSCMS.S("userid"))){%> checked<%} %> />所有会员(<span style="color:red"><%=DataFactoryUser.GetOnlyValue("select count(1) From KS_User") %></span>位)<br />
                ...
                <input type="radio" name="optype" onclick="jQuery('#grouparea').hide();" value="3" <%if (!string.IsNullOrEmpty(KSCMS.S("userid"))){%> checked<%} %>/>指定用户名&nbsp;&nbsp;<asp:TextBox CssClass="textbox" ID="ToUserName" runat="server"
                    Width="246px"></asp:TextBox>多个用户名间请用<font color="#0000ff">英文的逗号</font>分隔<div style="height:8px; clear:both"></div>
