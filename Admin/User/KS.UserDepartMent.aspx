...
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
 ...
 <div id="manage_top" class="menu_top_fixed">
            ...
            <li><a href="KS.UserGroup.aspx">用户组管理</a></li>
            <li class="curr"><a href="KS.UserDepartMent.aspx">用户部门管理</a></li>
        </ul>
    </div>
 <div class="menu_top_fixed_height"></div> 
 <div class="content-area">
 <div class="myTitle">用户部门管理<span style="float:right">
     <asp:Button ID="Button2" runat="server" Text="添加部门" CssClass="button" OnClick="lbtaddmodel_Click" />
     <asp:Button ID="Button1" runat="server" Text="一级部门排序" CssClass="button" OnClick="LinkButton1_Click" />
     <asp:Button ID="Button3" runat="server" Text="N级部门排序" CssClass="button" OnClick="LinkButton2_Click" /></span>
