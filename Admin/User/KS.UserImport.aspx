<%@ Page Title="" Language="C#"  MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="True" Inherits="Kesion.NET.WebSite.Admin_UserImport" Codebehind="KS.UserImport.aspx.cs" %>

<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
      <div id="manage_top" class="toptitle menu_top_fixed">
      	 <ul class="titleTab">
      		<li>操作导航：</li>
            <li><a href="KS.UserAdd.Aspx">新增用户</a></li>
            <li class="curr"><a href="KS.UserImport.Aspx">外部数据源批量导入</a></li>
          </ul>  
      </div>
