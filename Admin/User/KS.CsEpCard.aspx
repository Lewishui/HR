      ...
      <tr>
        <td align="right" class="lefttd" height="30" ><strong>格式文本：</strong></td>
         <td class="righttd">
           ...
           <a class="textarea_max" href="javascript:zoomtextarea(5,'<%=this.TextBox2.ClientID %>');"></a>
          <br />
            <p class="tips"> 请按照每行每张卡， 每张卡按“卡号＋分隔符＋密码”的格式录入</p>
            <p class="tips">例：734534759|kSo94Sf4Xs（以“|”作为分隔符）</p>
         </td>
     </tr>
     </tbody>
     ...
     <tr style="display:none">
      ...
      <tr>
        ...
        <tr>
            ...
            <td class="righttd">
             <asp:RadioButtonList ID="IsSell" runat="server" Width="170px" 
          ...
          <tr>
            ...
            <td class="righttd">
             <asp:RadioButtonList ID="IsUse" runat="server" Width="170px" 
                    RepeatDirection="Horizontal" Height="24px">
