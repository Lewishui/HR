<%@ Page Language="C#" ValidateRequest="false" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Inherits="Kesion.NET.WebSite.Admin_UserMobileLog" Title="手机绑定记录管理" Codebehind="KS.UserMobileLog.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
 ...
 <asp:Panel ID="Panel1" runat="server">
      <KS:TopNav ID="TopNav1" runat="server" Text="会员绑定及手机绑定记录管理" />
  ...
  <div>
    ...
    <ul class="tabs">
        <li><a href="KS.UserLoginLog.aspx"><span>会员绑定记录</span></a></li>
        <li class='active'><a href="KS.UserMobileLog.aspx"><span>会员手机绑定记录</span></a></li>
    </ul>
    </div>
        <KS:KSGV ID="MessageView" cssclass="CTable" runat="server" AutoGenerateColumns="False" DataKeyNames="FieldID" GridLines="None"
            OnRowDataBound="FieldListView_RowDataBound" OnRowCommand="list_RowCommand" PagerType="CustomNumeric" Width="99%" EnableTheming="True" EmptyDataText="找不到手机绑定记录!">
            <Columns>
    ...
    <div style="border:1px dashed #cccccc; background-color:#f0f9fe; margin-top:10px ;padding:10px; text-align: left; font-size: 12px;">
     <strong>特别提醒：</strong> 如果用户绑定记录表记录太多，影响了系统性能，可以删除一定时间段前的记录以加快速度。 
     <div>
