<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Inherits="Kesion.NET.WebSite.Admin_LogSms"  Title="查看短信发送记录" Codebehind="KS.LogSms.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
          ...
          手机短信发送管理
          	<div class="quickSearch">
                 ...
                 <asp:DropDownList ID="DrpSearchType" runat="server">
                     <asp:ListItem Value="0">手机号码</asp:ListItem>
                     <asp:ListItem Value="1">发送内容</asp:ListItem>
                     <asp:ListItem Value="2">IP地址</asp:ListItem>
                 </asp:DropDownList>
    ...
    <asp:Panel ID="Panel2" runat="server" Visible="false">
         ...
         <div id="manage_top" class="toptitle menu_top_fixed">
         	发送手机短消息
         	<ul>
             	<li id='p9'><b></b><a href='KS.LogSms.aspx'>返回</a></li> 
             </ul>
         </div>
        <div class="menu_top_fixed_height"></div> 
<div class="content-area">    
     <table width="100%" border="0" cellpadding="1" cellspacing="1" class="CTable"> 
          <tr>
            ...
            <td class="righttd">
                ...
                <input type="radio" name="optype" onclick="jQuery('#grouparea').hide();" value="4"<%=!string.IsNullOrEmpty(KSCMS.S("userid"))?" checked":"" %> />指定用户名
                <asp:TextBox ID="TxtToUserName" runat="server" CssClass="textbox" Width="246px" /><span class="tips">多个用户名间请用<font color="#0000ff">英文的逗号</font>分隔</span><div style="height:10px"></div>
                <input type="radio" name="optype" onclick="jQuery('#grouparea').hide();" value="3" />指定手机号码<asp:TextBox ID="ToMobile" runat="server"
                    Width="246px" CssClass="textbox"></asp:TextBox><span class="tips">多个手机号间请用<font color="#0000ff">英文的逗号</font>分隔</span></td>
          </tr>
