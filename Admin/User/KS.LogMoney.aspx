...
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
 ...
 &nbsp;&nbsp;<strong>用户名：</strong><asp:TextBox ID="TxtKeyWord" runat="server" Width="100" CssClass="textbox" />
...
<div class="content-area">
	<div class="myTitle">资金明细记录管理</div>
    ...
    <div class="tabs_header">
     <%if (!string.IsNullOrEmpty(KSCMS.S("userName"))){ %>
      ...
      <%} %>
        <ul class="tabs">
        <li class='active'><a href="KS.LogMoney.aspx"><span>资金明细</span></a></li>
