...
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
   ...
   <asp:Panel ID="ListPanel" runat="server" Width="100%">
    <script>
        function addPlan() {
            parent.openWin("添加工作计划", "<%=KSCMS.GetInstallDir()+MyCache.GetCacheConfig(4)%>/User/KS.AdminPlan.aspx?action=add", true, 720, 450);
        }
        function editPlan(id) {
            parent.openWin("修改工作计划", "<%=KSCMS.GetInstallDir()+MyCache.GetCacheConfig(4)%>/User/KS.AdminPlan.aspx?action=modify&id=" + id, true, 720, 450);
        } 
    </script>
    ...
    <asp:Panel ID="showPannel" runat="server" Width="100%" Visible="false">
        ...
        <asp:Repeater ID="showRepeater" runat="server"  >
         ...
         <ItemTemplate>
          ...
          <FooterTemplate>
               <tr class="tdbg emptycss" style="display:<%# bool.Parse((showRepeater.Items.Count==0).ToString())?"":"none"%>">
                <td class="Ctd" style="text-align:center" colspan="7">
                  <a href="javascript:;" onclick="addPlan()">还没有添加任何工作计划，点此添加&raquo;</a>
                </td>
               </tr> 
           </table>
