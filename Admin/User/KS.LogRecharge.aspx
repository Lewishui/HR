...
<div class="content-area">
  <div class="myTitle">在线充值记录管理</div>
           ...
           <asp:TemplateField HeaderText="操作">
            ...
            <asp:BoundField DataField="PlatName" HeaderText="支付平台" >
              ...
              <asp:TemplateField HeaderText="操作">
                ...
                <itemtemplate>
                 <%# Convert.ToInt16(Eval("status"))==2?"<a class='link-color' href='?action=addmoney&id="+Eval("id")+@"' onclick=""return(confirm('此操作不可逆，确定收到款项了吗？'));"">入账</a>":"" %>
                 <%# Convert.ToInt16(Eval("status"))!=2?"<a class='link-color' href='?action=del&id="+Eval("id")+@"' onclick=""return(confirm('此操作不可逆，确定删除吗？'))"">删除</a>":"" %>
