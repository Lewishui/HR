...
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
    <asp:Panel ID="listPanel" runat="server" Width="100%">
           <div id="manage_top" class="menu_top_fixed">
            ...
            <li><a href="KS.UserForm.aspx">用户表单管理</a></li>
            <li class="curr"><a href="KS.UserField.aspx">用户字段管理</a></li>
        </ul>
    </div>   
...
<div class="content-area">
	<div class="myTitle">
	 用户自定义字段管理
     <span style="float:right"><asp:Button ID="Button2" runat="server" Text="新增字段" CssClass="button" OnClick="addbutton_Click" /></span></div>
    ...
    <div>
        ...
        <KS:KSGV ID="FieldListView" cssclass="CTable" runat="server" AutoGenerateColumns="False" DataKeyNames="FieldID" GridLines="None"
            OnRowDataBound="FieldListView_RowDataBound" EmptyDataText="还没有添加任何字段!"  PagerType="CustomNumeric" Width="100%" EnableTheming="True" OnRowCommand="FieldListView_RowCommand">
            <Columns>
         ...
         <table width="99%" align="center" border="0" cellpadding="1" cellspacing="1" class="CTable"> 
            ...
            <tr>
             ...
             <tr>
                 ...
                 <td class="righttd" style="height: 39px">
                     <asp:TextBox CssClass="textbox" ID="AllowFileExt" runat="server" Text="jpg|gif|png" Width="212px"></asp:TextBox>
                     多个扩展名请用＂|＂隔开</td>
             </tr>
             <tr>
                 <td align="right" class="lefttd" style="width: 198px; height: 30px">
                 ...
                 <td class="righttd" style="height: 30px">
                     <asp:TextBox CssClass="textbox" ID="MaxFileSize" runat="server" Text="1024" Width="41px"></asp:TextBox>
