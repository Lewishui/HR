...
<asp:Content ID="Content1" ContentPlaceHolderID="KSContent" Runat="Server">
    ...
    <div class="myTitle"><asp:Label ID="LabCurrModel" runat="server" Text="Label"></asp:Label> 字段管理</div>  
    <div>
        ...
        <KS:KSGV ID="FieldListView" runat="server" AutoGenerateColumns="False" DataKeyNames="FieldID" GridLines="None"
         ...
         <asp:TemplateField HeaderText="采集项">
            ...
            <asp:Panel ID="Panel1" runat="server" CssClass="main-button">
...
<div class="content-area">          
         <table width="99%" align="center" border="0" cellpadding="1" cellspacing="1" class="CTable"> 
            ...
            <tr>
                ...
                <td class="righttd">
                    <asp:TextBox CssClass="textbox" ID="FieldName" placeholder="不超过20个字符" MaxLength="20" runat="server"></asp:TextBox>
                    ...
                    <div class="tips">字段名称以字母、数字、和下划线组成,并且只能以字母开头.在模板页的调用格式：<span style="color: #ff0066">{KS:Field:</span><span id="Fields" style="color: #ff0066">字段名称</span><span style="color: #ff0066">}</span></div></td>
            </tr>
             <tr>
                 ...
                 <td class="righttd" style="height: 30px">
                     ...
                     </span><span class="tips">如:你的姓名，联系方式等等</span></td>
             </tr>
             <tr>
                 <td align="right" class="lefttd" style="width: 198px; height: 30px">
                 ...
                 <td class="righttd" style="height: 30px">
                     ...
                     <span class="tips">显示在录入框旁边的提示信息</span></td>
             </tr>
             <tr>
                 <td align="right" class="lefttd" style="width: 198px; height: 30px">
                     <strong>字段类别：</strong></td>
                 <td class="righttd" style="height: 30px">
             ...
             <tr>
                 ...
                 <td class="righttd" style="height: 30px">
                     <asp:RadioButtonList ID="FieldType" runat="server" RepeatColumns="4" RepeatDirection="Horizontal">
                         ...
                         <asp:ListItem Value="7">日期</asp:ListItem>
                         ...
                         <asp:ListItem Value="15">日期+时间</asp:ListItem>
                         <asp:ListItem Value="16">绑定其它模型</asp:ListItem>
                     </asp:RadioButtonList></td>
             </tr>
             <tr id="showDefaultValue">
                 <td align="right" class="lefttd" style="width: 198px; height: 30px">
             ...
             <tr id="showBindModel" style="display:none">
                 <td align="right" class="lefttd" style="width: 198px; height: 30px">
                     <strong>请选择要绑定的模型：</strong></td>
                 <td class="righttd" style="height: 30px">
                     <asp:DropDownList ID="DrpModelID" runat="server"></asp:DropDownList>
                 </td>
             </tr>
                 ...
                 <tr>
                     ...
                     <td class="righttd" style="height: 30px">
                         <asp:DropDownList ID="Toolbar" runat="server">
                             ...
                             <asp:ListItem Value="Common">标准型编辑器</asp:ListItem>
                             <asp:ListItem Value="Content">增强型编辑器</asp:ListItem>
                         </asp:DropDownList></td>
                 </tr>
               </tbody>
             <tbody id="WidthArea">
             <tr>
                 ...
                 <td class="righttd" style="height: 30px">
                     <asp:TextBox CssClass="textbox" ID="Width" runat="server" Width="44px">350</asp:TextBox>
...
正确格式如：<span style="color:Red">男</span> 或 <span style="color:Red">0|男</span>    
             ...
             <tr>
                 ...
                 <td class="righttd" style="height: 39px">
                     <asp:TextBox CssClass="textbox" ID="AllowFileExt" Text="jpg|gif|png" runat="server" Width="212px"></asp:TextBox>
                     多个扩展名请用＂|＂隔开</td>
             </tr>
             <tr>
                 <td align="right" class="lefttd" style="width: 198px; height: 30px">
                 ...
                 <td class="righttd" style="height: 30px">
                     <asp:TextBox CssClass="textbox" ID="MaxFileSize" text="1024" runat="server" Width="41px"></asp:TextBox>
