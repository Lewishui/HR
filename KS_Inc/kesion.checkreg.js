...
function getMobileCode(){
	...
	$.ajax({type:"get",async:false,url:appurl+"user/regajax.ashx?istest=0&action=sendmobilecode&model=userreg&mobile="+mobile+"&anticache=" + Math.floor(Math.random()*1000),cache:false,dataType:"html",success:function(d){
		 if (d=='true'){
			leavePage();
		 }else{
